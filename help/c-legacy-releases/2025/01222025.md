...
[Experience League](https://experienceleague.adobe.com/it?lang=it#home) consente di saperne di più sulle applicazioni enterprise di Experience Cloud e Adobe. Per una migliore esperienza, accedi e personalizza la ricerca nella libreria di risorse gratuita, tra cui:
...
* [Forum della community](https://experienceleaguecommunities.adobe.com/?profile.language=it)
* [Supporto](https://experienceleague.adobe.com/it?support-tab=home&lang=it#support)
...
Data di rilascio: **giovedì 5 febbraio 2025**
...
|Published|Name|Type|Description |
| -----------| ---------- | ---------- | ---------- |
|October 2024|[Configure business rules - Frequency capping](https://experienceleague.adobe.com/it/docs/journey-optimizer-learn/tutorials/configuration/business-rules/configure-frequency-capping-rules)|Video |Learn how to configure frequency capping rules.| 
-->
