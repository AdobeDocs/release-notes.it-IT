---
title: Note sulla versione centrale - Febbraio 2025
...
[Experience League](https://experienceleague.adobe.com/it?lang=it#home) consente di saperne di più sulle applicazioni enterprise di Experience Cloud e Adobe. Per una migliore esperienza, accedi e personalizza la ricerca nella libreria di risorse gratuita.

* **Lasciare un feedback:** Cercare **_Questo contenuto è stato utile?_** pop-up nella parte inferiore di ogni articolo o video. Il tuo feedback viene curato e distribuito agli autori di contenuti.
...
La nuova pagina [Home di Experience League](https://experienceleague.adobe.com/it?lang=it) include consigli di apprendimento personalizzati basati su [!DNL Adobe Target].
...
[Ulteriori informazioni...](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-cloud/discover-smarter-faster-learning-with-experience-league-s-new/td-p/739750?profile.language=it)
...
| -----------| ---------- | ---------- | ---------- |
|January 2025|[Adobe [!DNL Analytics] & CJA: Quick Start for Basic to Intermediate Analysis Capabilities](https://experienceleague.adobe.com/it/docs/events/adobe-customer-success-webinar-recordings/2024/basic-to-intermediate-analysis-capabilities)|Event |Learn about Adobe [!DNL Analytics] and [!DNL Customer Journey Analytics] with a focus on basic to intermediate analysis capabilities.|
|January 2025|[AEP Web SDK Troubleshooting, Assurance, and Tips and Tricks](https://experienceleague.adobe.com/it/docs/events/tech-sessions/2024/rtcdp-office-hours-2024/aep-web-sdk-troubleshooting)|Event |Gain insights into troubleshooting, assurance, and tips and tricks for the Adobe [!DNL Experience Platform] (AEP) Web SDK.| 
-->
...
|September 2024|[Marketo Measure Ultimate overview](https://experienceleague.adobe.com/it/docs/marketo-measure-learn/tutorials/marketo-measure-ultimate/overview)|New video |Learn how Marketo Measure Ultimate allows B2B marketers to gather data from almost any source, including multiple sources of the same type, for thorough attribution. |
|September 2024|[API Help - How to set the Access token in a variable](https://experienceleague.adobe.com/it/docs/marketo-learn/tutorials/integrations/api-set-access-token-variable)|New video |Learn how to set up the Postman application and leverage variables to save data into the variable for reusability purposes. You will also learn how to make your first Marketo Engage REST API call to get the access token.|
|September 2024|[Go live with Dynamic Chat in just 15 minutes](https://experienceleague.adobe.com/it/docs/marketo-learn/tutorials/dynamic-chat/go-live-in-15-minutes)|New video |Watch a step by step guide to help you go live with your first dialogue using Dynamic Chat in just 15 minutes.| 
-->
