---
title: Note sulla versione centrale - Settembre 2023
...
* Experience Manager Assets ora include una nuova versione 9 dell&#39;indice `damAssetLucene`. `damAssetLucene-9` modifica il comportamento del conteggio dei facet di Oak Query in [non valuta più il controllo degli accessi sui conteggi dei facet](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/search-assets.html?lang=it) restituiti dall&#39;indice di ricerca sottostante, il che si traduce in tempi di risposta di ricerca più rapidi.
...
* **Adobe Analytics con Experience Cloud Setup Automation per Forms**: ora puoi abilitare Adobe Analytics con Experience Cloud Setup Automation selezionando un paio di pulsanti. Consente di connettere [!DNL AEM Forms as a Cloud Service] con i tag di Experience Platform e Adobe Analytics, per acquisire e tenere traccia delle metriche delle prestazioni per i moduli pubblicati.
...
* [Aggiornamento della versione 2023.8.0 di Experience Manager as a Cloud Service](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/aem-as-a-cloud-service-2023-8-0-release-update/ba-p/616365?profile.language=it).
* [AEM Community Lens 7ª edizione, agosto 2023](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/adobe-experience-manager-community-lens-7th-edition-august-2023/ba-p/614084?profile.language=it).
* [Utenti AEM - Condividi il tuo feedback su Gartner Peer Insights.](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-experience-manager-users-share-your-feedback-on-gartner/td-p/613702?profile.language=it)
...
| Settembre 2023 | AEM Foundation | [Utilizzare la procedura guidata per SSL in AEM](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/security/use-the-ssl-wizard.html?lang=it) | Video | Scopri come configurare SSL in Adobe Experience Manager per eseguirlo su HTTPS utilizzando la procedura guidata SSL incorporata. |
