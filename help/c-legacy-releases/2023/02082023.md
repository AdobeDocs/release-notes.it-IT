---
title: Note sulla versione centrale - Febbraio 2023
...
Per una pianificazione completa, consulta [Eventi su Experience League](https://experienceleague.adobe.com/events?lang=it/).
...
* Le notifiche di stato sono ora disponibili su [!DNL Slack]. Con un’unica configurazione, puoi aggiungere l’app [!DNL Adobe Status Slack] alla tua area di lavoro [!DNL Slack] e ricevere le notifiche di stato sul canale [!DNL Slack]. Utilizza questo collegamento per gestire le preferenze di abbonamento: [https://status.adobe.com/it-it/proactive-notifications/manage](https://status.adobe.com/it/proactive-notifications/manage).
...
<!-- For the latest release information, see Adobe System Status [release notes](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html?lang=it#status). -->
...
| -----------| ---------- | ---------- | ---------- |
|January 2023|[Schedule Customer Journey Analytics workbooks using Report Builder](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/exporting/report-builder/schedule-cja-workbooks-using-report-builder.html?lang=it)|Video |Learn how to schedule workbooks in Report Builder for Customer Journey Analytics. Scheduling workbooks lets users automate the process of refreshing Report Builder workbooks with the latest data and sending it to stakeholders on a regular, pre-defined schedule.|
|January 2023|[Leverage date field support](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/use-cases/data-views-use-cases/leverage-date-field-support.html?lang=it)|Video |You can use date and date-time fields within Customer Journey Analytics. Select how the date or date-time field is displayed, and use date-specific logical operators in the include/exclude functionality to filter what is displayed.|
|January 2023|[First-time and returning sessions](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/use-cases/data-views-use-cases/first-time-and-returning-sessions.html?lang=it)|Video |Learn how to distinguish between first-time and returning sessions for your users. This is accomplished through a 13-month look-back applied to your report.|
|January 2023|[Use the experimentation panel](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/panels/use-the-experimentation-panel.html?lang=it)|Video |Learn how to configure and use the experimentation panel, which automatically builds some visualizations based on your experiment data.|
...
Versione più recente: **venerdì 22 settembre 2022**
...
* Editor modelli per **[!UICONTROL Moduli adattivi]**: l’editor di modelli ti consente di predefinire la struttura e l’aspetto di base dei [!UICONTROL Moduli adattivi] di un’organizzazione. Questa versione include i seguenti miglioramenti all’editor modelli:
   * **[Modello dati modulo nell’editor modelli](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/create-an-adaptive-form/create-an-adaptive-form-on-forms-cs/creating-adaptive-form.html?lang=it#edit-form-model-properties-of-an-adaptive-form-edit-form-model)**: è possibile associare uno schema Modello dati modulo a un modello per [!UICONTROL Moduli adattivi] nell’editor modelli. Consente di ridurre il tempo necessario per creare un [!UICONTROL Modulo adattivo]. Questa opzione è stata aggiunta anche all’editor di [!UICONTROL Moduli adattivi] per consentire agli utenti di selezionare o modificare il Modello dati modulo per i moduli esistenti.
...
* **Prossimo webinar Experience Manager GEMs:** _Accelerazione dello sviluppo Experience Manager as a Cloud Service con ambienti di sviluppo rapido_. [Registrati qui](https://bit.ly/3x1Cl8x).
...
* **Obiettivo community Adobe Experience Manager:** evidenzia gli ultimi aggiornamenti della community Experience Manager, il tutto in un&#39;unica posizione. [Leggi la quarta edizione](https://bit.ly/3CAxuy2).
