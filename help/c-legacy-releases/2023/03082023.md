...
* [Aggiornamenti delle versioni di Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-release-overview-events/aemcsupdates/overview.html?lang=it)
...
| Funzione | Descrizione |
| ------- | ----------- |
| [!UICONTROL Campagne] | ([!DNL Microsoft Advertising] campagne per il pubblico; versione beta aperta; rilascio: 18 marzo) Le campagne per il pubblico possono ora utilizzare la strategia di offerta CPC (eCPC) avanzata. Puoi impostare le offerte nelle impostazioni del gruppo di annunci figlio.<br><br>Le campagne di pubblico con eCPC possono essere incluse nei portfolio per l&#39;ottimizzazione. |
