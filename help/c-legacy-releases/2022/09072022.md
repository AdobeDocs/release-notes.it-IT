...
>[!NOTE]
>
>Torna spesso a controllare per essere sempre al corrente delle novità di Experience League.
...
* Le schede del programma nella pagina di destinazione di Cloud Manager e l’esperienza associata sono ora aggiornate.
...
* [Note sulla versione di Amazon Sales Channel](https://experienceleague.adobe.com/docs/commerce-channels/amazon/release-notes.html?lang=it)
...
|  | ([!DNL Google Ads] account) La vista Campagne > Annunci ora include una colonna opzionale [!UICONTROL Forza annuncio] che indica quanto ogni annuncio di ricerca responsive (RSA) segue [!DNL Google Ads] best practice per le prestazioni.<br><br>[!DNL Microsoft® Advertising] non abilita ancora un supporto simile tramite la relativa API. |
...
| [!UICONTROL Approfondimenti sulla pubblicità] | La vista [!UICONTROL Approfondimenti sulla pubblicità] ha un nuovo aspetto e un nuovo flusso di lavoro, basati su una nuova infrastruttura che migliora le prestazioni e l&#39;affidabilità. Ora fai clic sul nome di un insight, seleziona o immetti le impostazioni, quindi fai clic su [!UICONTROL Genera Insight].<br><br>Per tornare temporaneamente alla vista legacy, abilita [!UICONTROL Passa alla vecchia interfaccia utente] in alto a destra. La vista legacy verrà rimossa alla fine di settembre. |
