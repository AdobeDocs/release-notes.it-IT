---
title: Note sulla versione centrale - Luglio 2022
...
La funzionalità [!UICONTROL Raccolta dati] di Adobe Experience Platform include [tag](https://experienceleague.adobe.com/docs/tags.html) per una gestione dei tag semplificata e universale e offre un’infrastruttura di dati in streaming affidabile, solida e completa. I tag semplificano la raccolta di dati sull’esperienza del cliente e agevolano la distribuzione delle esperienze.
...
* [ID visitatore](https://experienceleague.adobe.com/docs/core-services/interface/services/core-services.html#section_3C9F6DF37C654D939625BB4D485E4354)
...
| ------- | ------- |
| Home unificata, widget di accesso rapido | **Naviga più velocemente:** ora puoi personalizzare ulteriormente la tua esperienza della home e decidere quali applicazioni avere a portata di mano. Utilizza la nuova funzione di blocco per selezionare le applicazioni da mostrare in primo piano e al centro nell&#39;[!UICONTROL Accesso rapido]. <br>**Rimani informato con il blocco intelligente:** Le nuove applicazioni ora sono più facili da trovare. Le nuove applicazioni assegnate presentano il badge _Nuovo_ e vengono bloccate automaticamente nell’[!UICONTROL Accesso rapido]. |
...
Rilascio pianificato: **giovedì 27 luglio 2022**
...
* Il nuovo [componente Sommario](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/components/tableofcontents.html) funziona non solo con [!UICONTROL componenti core], ma con tutti i componenti, eseguendo automaticamente il rendering del sommario nelle pagine dei contenuti. Inoltre, poiché il rendering è eseguito lato server e completamente memorizzato nella cache dal dispatcher, è anche efficiente da caricare.

### Experience Manager [!DNL Assets] as a [!DNL Cloud Service]

Nuove funzioni in [!DNL Assets]:

* Experience Manager [!DNL Assets] utilizza le funzionalità di Adobe AI per [distinguere i colori in un&#39;immagine e applicarli automaticamente come tag al momento dell&#39;acquisizione](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/color-tag-images.html). Questi tag consentono un’esperienza di ricerca avanzata, in base alla composizione cromatica dell’immagine. Puoi configurare il numero di colori, compresi tra uno e quaranta, con cui un’immagine viene taggata in modo da poter cercare le immagini in base a tali colori in un secondo momento.
...
* Il popover nella scheda [Ripristina contenuto](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/operations/backup.html) della pagina dei dettagli degli ambienti visualizza ora un utile elenco di comandi Git che consentono all’utente di visualizzare le modifiche localmente.
...
| luglio 2022 | [Configurazione di OSGi per Adobe Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/deploying/configuring-osgi.html) | Video | Scopri come configurare OSGi per AEM CS. Ad esempio, scopri come gestire i bundle OSGi e le impostazioni di configurazione per i componenti OSGi tramite file di configurazione che fanno parte di un progetto di codice AEM. | AEM as a Cloud Service |
| luglio 2022 | [Sovrascrivere le proprietà dei modelli di dati per moduli](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/adaptive-forms/override-fdm-values.html) | Video | Scopri come sovrascrivere le proprietà dei modelli di dati per moduli per facilitare la verifica di un modello dati modulo rispetto a endpoint diversi. | AEM [!DNL Forms] |
...
| luglio 2022 | [Dashboard di Site-Wide Analysis Tool](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/tools/site-wide-analysis-tool.html?lang=it) | Video | Scopri Site-Wide Analysis Tool. Questa funzione consiste in uno strumento proattivo e self-service e un archivio centrale che include informazioni dettagliate sul sistema e consigli per garantire la sicurezza e l’operabilità dell’installazione di Adobe Commerce. |
...
* [Versione Pannello di controllo Campaign di giugno](https://experienceleague.adobe.com/docs/control-panel/using/release-notes/release-notes.html?lang=it)
...
| Agosto 2022 | [Approfondimento sulle impostazioni di sistema per gli amministratori di Workfront](https://experienceleague.adobe.com/?recommended=Workfront-A-1-2022.2.admin&lang=it) | Corso | Scopri le impostazioni di sistema per migliorare l’esperienza utente, ad esempio l’organizzazione degli utenti, i moduli personalizzati, i processi le milestone di approvazione, e i modelli layout. |
...
| Funzione | Descrizione |
| ------- | ----------- |
| [!UICONTROL Campagne] | (Consenso a funzione Beta per tutti gli inserzionisti; versione del 16 luglio) Ora puoi creare e gestire campagne [!DNL Google Ads] con prestazione massima, tra cui la creazione manuale di gruppi di risorse e il caricamento di risorse. I collegamenti ai feed di prodotto di [!DNL Google Merchant Center] non sono supportati.<br><br>Una volta che hai dato il consenso per la versione di prova, puoi creare campagne con il [!UICONTROL Tipo di campagna] &quot;[!UICONTROL Prestazioni massime]&quot; e impostare gruppi di risorse nelle impostazioni della campagna. Nella vista [!UICONTROL Campagne], puoi anche visualizzare le campagne con prestazione massima esistenti, con i dati sulle prestazioni in formato tabella e grafico dell’andamento. I dati sulle prestazioni a livello di campagna sono disponibili anche nei report e in Adobe Analytics (per gli inserzionisti con un&#39;integrazione [!DNL Analytics]).<br><br>Per dare il consenso alla versione beta, contatta il team dell&#39;account [!DNL Adobe]. |
...
| Pubblicato | Nome | Tipo | Descrizione | Applicazione |
| -----------| ---------- | ---------- | ---------- |---------- |
| luglio 2022 | [Utilizzo del ruolo di responsabile approvazione](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-sending/add-an-approver.html) | Video (aggiornato) | Scopri come inviare un documento attraverso un processo di approvazione. | Adobe Sign |
...
| luglio 2022 | [Creazione e gestione dei gruppi](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/create-and-manage-groups.html) | Video (aggiornato) | Scopri come creare gruppi, aggiungervi utenti e modificarne le impostazioni. | Adobe Sign |
| luglio 2022 | [Delegare la firma a un altro utente](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-signing/delegate-signing.html) | Video (aggiornato) | Scopri come delegare la firma di un documento a un altro utente. | Adobe Sign |
