...
Versione più recente: **giovedì 28 settembre 2022**
...
_Nuove funzioni nel [!DNL Sites]canale pre-release_
...
* [Aggiornamenti delle versioni di Adobe Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-release-overview-events/aemcsupdates/overview.html?lang=it)
...
| Funzione | Descrizione |
| ------- | ----------- |
| [!UICONTROL Campagne] | (Versione del 6 ottobre) Sono disponibili nuove colonne di metriche relative alla velocità per le visualizzazioni delle [!UICONTROL Campagne]: “[!UICONTROL OTS di ieri]” (OTS, on target spend: spesa in linea con il target), “[!UICONTROL Consegna di ieri]”, “[!UICONTROL Obiettivo di ieri]”, “[!UICONTROL OTS di oggi]”, “[!UICONTROL Consegna di oggi]” e “[!UICONTROL Obiettivo di oggi]”. |
...
| [!UICONTROL Consigli] | (Solo account [!DNL Google Ads]) La funzionalità [!UICONTROL Consigli] non è più in versione Beta ed è stata rilasciata con disponibilità generale.<ul><li>Visualizza subito tutti i consigli di [!DNL Google Ads] sui quali non è stata eseguita alcuna azione per un account.</li><li>Applica e ignora i consigli per un account.</li><li>Visualizza i registri di ogni consiglio applicato a un account.</li></ul> |
