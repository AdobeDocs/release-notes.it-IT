...
* **Experience Manager as a Cloud Service**
  ...
  Il [video introduttivo sulla versione di aprile 2022](https://video.tv.adobe.com/v/3452787?captions=ita&quality=12) offre un riepilogo delle funzioni aggiunte nella versione 2022.4.0 (aprile 2022).<!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
