...
* **Experience Manager as a Cloud Service**
  ...
  Guarda il [video introduttivo sulla versione di maggio 2022](https://video.tv.adobe.com/v/3453441/?captions=ita&quality=12) per un riepilogo delle funzioni aggiunte nella versione 2022.5.0 (maggio 2022). <!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
