---
title: Note sulla versione centrale - Giugno
...
Rilascio pianificato: **martedì 11 luglio 2022**
...
Rilascio pianificato: **giovedì 22 giugno 2022**
...
* **Experience Manager Sites as a Cloud Service**
   ...
   * Una [nuova console](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/headless/content-fragments/content-fragment-console.html) ottimizzata per un uso headless dei frammenti di contenuto
...
* **Experience Manager Assets as a Cloud Service**
   ...
   * Experience Manager Assets utilizza le funzionalità di Adobe AI per [distinguere i colori in un&#39;immagine e applicare automaticamente le differenze come tag al momento dell&#39;acquisizione](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/color-tag-images.html). Questi tag consentono un’esperienza di ricerca avanzata, in base alla composizione cromatica dell’immagine. Puoi configurare il numero di colori, compresi tra uno e 40, con cui un’immagine viene taggata in modo da poter cercare le immagini in base a tali colori in un secondo momento.
...
* Webinar GEMs, _Uno sguardo approfondito: Cloud Manager 2022_
   ...
   * 08:00 Ora del Pacifico; 17:00 Ora dell’Europa centrale; 20:30 Ora standard dell’India
...
| -----------| ---------- | ---------- | ---------- | ------|
| Giugno 2022 | Componenti di [[!DNL Forms] Portal](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/developing-for-cloud-service/forms-portal-components.html) | Video | Scopri come abilitare i componenti di [!DNL AEM Forms] [!UICONTROL Portal] in Forms Cloud Service. | AEM Forms CS |
| Giugno 2022 | [Integrazre AEM e il framework CIF per creare un’esperienza di e-commerce ricca e coinvolgente](https://experienceleague.adobe.com/docs/experience-manager-gems-events/gems/gems2022/aem-and-cif-framework-integration.html) | Video | Scopri come il framework CIF di Adobe può essere utilizzato per creare un’esperienza di e-commerce coerente, ricca di contenuti e coinvolgente. | AEM e framework CIF |
...
| Giugno 2022 | [Configurazioni cloud basate sul contesto](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/developing-for-cloud-service/context-aware-fdm.html) | Video | Scopri come definire le configurazioni cloud basate sul contesto in AEM Forms su Cloud Service. | AEM Forms |
...
* [[!DNL Experience Manager Guides]](https://experienceleague.adobe.com/docs/experience-manager-xml-documentation-learn/videos/overview.html): tutorial su Experience League
...
* Nuova [versione di maggio del Pannello di controllo](https://experienceleague.adobe.com/docs/control-panel/using/release-notes.html#may-2022)
...
| Giugno 2022 | [Configurazione delle notifiche per eventi e avvisi](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/set-up-shared-events-and-alert.html) | Video | Scopri gli eventi condivisi e le impostazioni degli avvisi che puoi configurare in Acrobat Sign. Gli avvisi sono azioni che non hanno avuto luogo in un determinato arco temporale, mentre gli eventi sono azioni che hanno avuto luogo. |
