---
title: Note sulla versione centrale - Marzo 2022
...
Data di rilascio: **giovedì 23 marzo 2022**
...
* **Experience Manager as a Cloud Service**
  ...
  * **Experience Manager Assets as a Cloud Service**
    ...
    * Dynamic Media offre ora la flessibilità di [configurare un account alias per l’azienda](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/dynamicmedia/dm-alias-account.html) nell’interfaccia utente, in modo che gli URL predefiniti di Dynamic Media e il codice da incorporare del visualizzatore vengano aggiornati. Questa azione influisce positivamente sull’ottimizzazione SEO (Search Engine Optimization), per riflettere gli aggiornamenti apportati al contesto aziendale, ad esempio il rebranding.
