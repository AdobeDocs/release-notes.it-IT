...
* **Experience Manager as a Cloud Service**
  ...
  Guarda il video di panoramica sulla versione di [marzo 2022](https://video.tv.adobe.com/v/3454204?captions=ita) per un riepilogo delle funzioni aggiunte nella versione 2022.3.0 (marzo 2022). <!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
