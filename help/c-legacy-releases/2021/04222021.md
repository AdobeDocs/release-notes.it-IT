...
* È stato risolto un problema in [Rapporti generali](https://experienceleague.adobe.com/docs/audience-manager/user-guide/reporting/general-reports.html#reporting) a causa del quale, se l’utente selezionava una data nel controllo **[!UICONTROL Per date fino a]**, i dati del rapporto risultavano spostati di un giorno. (AAM-57702)
* È stato risolto un problema in [Amministrazione > Gruppi](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/administration/administration-overview.html#create-group) a causa del quale gli utenti ricevevano un errore di tipo _Il gruppo è stato salvato correttamente, ma si è verificato un errore durante il salvataggio delle autorizzazioni del gruppo_ a causa di timeout. (AAM-57406, AAM-57411)
...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Commerce as a Cloud Service**
      ...
      * È stato rilasciato il sito di riferimento CIF Venia (25-03-2021), che include la versione più recente dei Componenti core di CIF 1.9.0. Per ulteriori dettagli, consulta [Sito di riferimento CIF Venia - 2021.03.25](https://github.com/adobe/aem-cif-guides-venia/releases/tag/venia-2021.03.25).
      * È stata rilasciata la versione 1.9.0 dei Componenti core di CIF. Per ulteriori dettagli, consulta [Componenti core CIF 1.9.0](https://github.com/adobe/aem-core-cif-components/releases/tag/core-cif-components-reactor-1.9.0).
