...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Commerce as a Cloud Service**
      ...
      * È stata rilasciata la versione 1.8.0 dei componenti core CIF. Per ulteriori informazioni, consulta la sezione su [Componenti core CIF 1.8.0](https://github.com/adobe/aem-core-cif-components/releases/tag/core-cif-components-reactor-1.8.0).
