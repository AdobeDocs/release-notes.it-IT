---
title: Note sulla versione centrale - Maggio 2021
...
* È stato aggiunto il [codice di errore di sistema DCS 10](https://experienceleague.adobe.com/docs/audience-manager/user-guide/api-and-sdk-code/dcs/dcs-api-reference/dcs-error-codes.html?lang=it#system-error-codes) per indicare che le caratteristiche della richiesta sono state valutate parzialmente o non sono state valutate affatto.
...
* **Adobe Experience Manager as a Cloud Service**
  ...
  * **Experience Manager Commerce as a Cloud Service**
    ...
    * Nuovo componente core per la navigazione CIF che estende il componente core per la navigazione WCM.
...
* **[Un nuovo processo per l’invio di Richieste di funzioni di Experience Manager](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/announcing-the-new-process-to-submit-experience-manager-feature/td-p/380425?profile.language=it)**
...
| -----------| ---------- |
| Impostazioni dei pacchetti | È disponibile una nuova opzione [!UICONTROL Velocità della strategia di riempimento], “[!UICONTROL Appena superiore]” ed è l’impostazione predefinita per i nuovi pacchetti. Questa strategia accelera la consegna in modo che sia completata al 55-65% a metà della durata del volo. |
