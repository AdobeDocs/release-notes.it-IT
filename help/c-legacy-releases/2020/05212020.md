...
Hai bisogno di aiuto? Visita [[!DNL Experience League]](https://experienceleague.adobe.com/it?lang=it#home) per trovare corsi specifici per Adobe, documentazione tecnica, risposte rapide, approfondimenti dalla community e corsi di formazione condotti da istruttori.
...
| Distribuzione di software | `experience.adobe.com/downloads` |
...
Data di aggiornamento: **sabato 15 maggio 2020**
...
* [Supporto degli attributi del cliente per il CCPA](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/ccpa.html?lang=it) (California Consumer Privacy Act, legge sulla privacy dei consumatori della California)
* [Supporto degli attributi del cliente per il GDPR](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/gdpr.html?lang=it) (Regolamento generale sulla protezione dei dati)
...
* [Video dimostrativi](https://experienceleague.adobe.com/docs/platform-learn/tutorials/journey-orchestration/introduction.html?lang=it)
...
| API di [!UICONTROL inserimento dati in blocco] | 31 maggio 2020 | Consente di inserire batch di dati Analytics in modo semplice e indipendente. Utile per dati lato server e offline. [Ulteriori informazioni...](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/bdia.md) |
...
Consulta le [informazioni sul tracciamento dello stato del lettore](https://experienceleague.adobe.com/docs/media-analytics/using/player-state-tracking/player-state-overview.html?lang=it).
...
* Sono stati risolti i problemi di latenza nell’[!UICONTROL API di acquisizione in blocco]. (AN-210165)
...
* **AEM as a Cloud Service**
   ...
   * Miglioramenti delle prestazioni di acquisizione di risorse Dynamic Media.
...
* **Community di AEM Experience League**
  ...
  Entra in contatto con la [Community di AEM Experience League](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/ct-p/adobe-experience-manager-community?profile.language=it): fai domande agli altri studenti ed esperti di AEM, sfoglia i thread e condividi i tuoi suggerimenti e le tue competenze.
...
* [Documentazione di AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html?lang=it)
...
| Funzione | Descrizione |
| -----------| ---------- |
| Gestione chiavi GPG | Installa e/o genera chiavi GPG in un’istanza di marketing per crittografare i dati inviati da Campaign e decrittografare i dati in arrivo. |
