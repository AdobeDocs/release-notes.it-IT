...
* **Labs (anteprime di tecnologie):** Questa nuova funzionalità di Analytics consente di testare i nuovi prototipi di funzionalità in produzione e di fornire ad Adobe un feedback prezioso. [Ulteriori informazioni...](https://experienceleague.adobe.com/docs/analytics/analyze/tech-previews/overview.html?lang=it)
