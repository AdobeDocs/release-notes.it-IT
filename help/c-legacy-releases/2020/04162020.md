...
* Utilizzando il tuo Adobe ID, puoi abbonarti alle notifiche degli eventi con maggiore granularità, fino al livello dell’offerta dei prodotti e dei componenti aggiuntivi. Inoltre, nell’ultima versione, nel processo di autoabbonamento viene ora consigliata una selezione di prodotti e servizi sulla base dei prodotti di cui attualmente disponi. Questo dovrebbe sia semplificare il processo di abbonamento riducendo il numero di decisioni o clic necessari, sia determinare l’invio di notifiche più rilevanti. Per iniziare, consulta [status.adobe.com/subscriptions](https://status.adobe.com/it-it/proactive-notifications/subscriptions/edit).
