...
Per un esempio dell’interfaccia di Experience Cloud, consulta la [documentazione del prodotto](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=it).
...
| -----------| ---------- | ---------- |
| Fine del ciclo di vita di Adobe Data Connectors | 13 luglio 2020 | Adobe Data Connectors si basa su una tecnologia legacy, che non è più disponibile o supportata. Per continuare a offrire e supportare le integrazioni, si consiglia di adottare il nuovo programma standard [Adobe Exchange Partner Program](https://partners.adobe.com/exchangeprogram/experiencecloud). La data ufficiale di fine del ciclo di vita è ancora da definire, ma è prevista nei prossimi 12-18 mesi, nella seconda metà del 2021. [Ulteriori informazioni...](https://experienceleague.adobe.com/docs/analytics/import/dataconnectors/data-connectors-eol.html?lang=it) |
...
* **Dynamic Media Classic**
  ...
  Consulta [App Adobe Dynamic Media Classic Desktop - Ora disponibile](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/new-ui-2020.html?lang=it).
...
* **Supporto per risorse 3D aggiunto ad Dynamic Media**
   ...
   * Per AEM as a Cloud Service, consulta [Utilizzo di risorse 3D in Dynamic Media](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/assets-3d.html?lang=it).
   * Per AEM 6.5, consulta [Utilizzo di risorse 3D in Dynamic Media](https://experienceleague.adobe.com/docs/experience-manager-65/assets/dynamic/assets-3d.html?lang=it).
...
* **Aggiornamenti alla documentazione di AEM 6.5.5 Forms**
   ...
   * Nuove funzioni e miglioramenti introdotti nella versione 6.5.5:
      ...
      * [Possibilità di personalizzare le colonne della casella in entrata di Adobe Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-65/authoring/essentials/inbox.html?lang=it#inbox-admin-control).
      * [Possibilità di salvare le comunicazioni interattive come bozza.](https://experienceleague.adobe.com/docs/experience-manager-65/forms/interactive-communications/prepare-send-interactive-communication.html?lang=it#save-as-draft)
      ...
      * [Miglioramenti all’accessibilità](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/new-features-latest-service-pack.html?lang=it#accessibility-improvements)
      * [Autenticazione basata su certificato X-509 per i servizi web basati su SOAP nel modello dati modulo.](https://experienceleague.adobe.com/docs/experience-manager-65/forms/form-data-model/configure-data-sources.html?lang=it#configure-soap-web-services)
      * [Supporto di Oracle RAC.](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/new-features-latest-service-pack.html?lang=it#other-improvements)
      * [Registrazione migliorata degli errori nella generazione di rapporti sulle transazioni.](https://experienceleague.adobe.com/docs/experience-manager-65/forms/transaction-reports/viewing-and-understanding-transaction-reports.html?lang=it#view-transaction-reporting-logs)
   * Nuove funzioni e miglioramenti nella versione 6.4.8.1:
      * [Autenticazione basata su certificato X-509 per i servizi web basati su SOAP nel modello dati modulo.](https://experienceleague.adobe.com/docs/experience-manager-64/forms/form-data-model/configure-data-sources.html?lang=it#configure-soap-web-services)
      * [Registrazione migliorata degli errori nella generazione di rapporti sulle transazioni.](https://experienceleague.adobe.com/docs/experience-manager-64/forms/transaction-reports/viewing-and-understanding-transaction-reports.html?lang=it#view-transaction-reporting-logs)
...
| -----------| ---------- | ---------- | ---------- |
| 25 giugno 2020 | [Guida introduttiva ai moduli adattivi](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/creating-your-first-adaptive-form/adaptive-forms-getting-started-tutorial-use.html?lang=it) | Video | Queste esercitazioni descrivono come creare moduli adattivi con più schede. Scopri come usare le tabelle, il layout a soffietto e l’editor di regole per la creazione di regole di business. |
| 25 giugno 2020 | [Creazione di un flusso di lavoro di revisione in AEM Forms](https://video.tv.adobe.com/v/3410035?captions=ita) | Video | Scopri come creare un flusso di lavoro per la revisione dei dati inviati tramite un modulo attivo. |
| 23 giugno 2020 | [Profili di elaborazione](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/configuring/processing-profiles.html?lang=it) | Video | I profili di elaborazione definiscono le rappresentazioni da creare per le risorse in AEM as a Cloud Service. |
| 23 giugno 2020 | [Best practice per Dynamic Media Classic](https://experienceleague.adobe.com/docs/experience-manager-learn/dynamic-media-classic-tutorial/overview.html?lang=it) | Articolo | Gli utenti nuovi e attuali possono scoprire Dynamic Media Classic, le sue funzionalità principali e il flusso di lavoro di _creazione_, _authoring_ e _distribuzione_. |
| 23 giugno 2020 | [Debug delle build e implementazioni di AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/build-and-deployment.html?lang=it) | Articolo | Scopri come eseguire il debug delle build e delle implementazioni di AEM as a Cloud Service. |
| 16 giugno 2020 | [Debug di AEM as a Cloud Service tramite i registri](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/logs.html?lang=it) | Articolo | Scopri come utilizzare i registri per eseguire il debug di AEM as a Cloud Service. I registri fungono da strumenti di prima linea per il debug delle applicazioni AEM, ma dipendono dalla registrazione appropriata nell’applicazione AEM implementata. |
| 5 giugno 2020 | [Progetto per l’editor di applicazioni a pagina singola](https://experienceleague.adobe.com/docs/experience-manager-learn/spa-react-tutorial/create-project.html?lang=it) | Articolo | Scopri come utilizzare l’archetipo di progetto Adobe Experience Manager (AEM) per generare un progetto Maven con più moduli come punto di partenza per un’applicazione React integrata con l’editor di applicazioni a pagina singola di AEM. |
...
| ----------- | ----------- | ---------- | ---------- |
| 26 giugno 2020 | [Interfaccia utente di Adobe Campaign Classic](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/getting-started/exploring-the-adobe-campaign-classic-user-interface.html?lang=it) | Campaign Classic | Questo video illustra l’interfaccia utente principale di Adobe Campaign Classic e mostra come accedere alle funzioni principali. |
| 8 luglio 2020 | [Installazione e configurazione del client Adobe Campaign](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/getting-started/install-and-setup-the-adobe-campaign-client.html?lang=it) | Campaign Classic | Scopri come scaricare e installare la console client di Adobe Campaign, creare e gestire le connessioni a più ambienti e verificare l’accesso alla console client di Adobe Campaign. |
| 19 giugno 2020 | [Introduzione ad Adobe Campaign Classic](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/getting-started/introduction-to-adobe-campaign-classic.html?lang=it) | Campaign Classic | Scopri come Adobe Campaign Classic si inserisce nel portfolio Adobe Digital Experience e le sue funzionalità principali. |
| 12 giugno 2020 | [Implementazione di un modello di consegna e-mail ad hoc](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/using-delivery-templates/deploying-ad-hoc-email-delivery-template.html?lang=it) | Campaign Classic | Scopri come implementare un modello e-mail ad hoc. |
| 12 giugno 2020 | [Configurazione di un modello di consegna](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/using-delivery-templates/configuring-a-delivery-template.html?lang=it) | Campaign Classic | Scopri come configurare un modello e-mail. |
| 12 giugno 2020 | [Impostazione delle proprietà del modello di consegna](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/using-delivery-templates/setting-delivery-template-properties.html?lang=it) | Campaign Classic | Scopri come impostare le proprietà del modello e-mail. |
| 26 giugno 2020 | [Introduzione all’interfaccia di Adobe Campaign Standard](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/getting-started/getting-started-with-the-ui.html?lang=it) | Campaign Standard | Questo video offre una panoramica dell’interfaccia di Adobe Campaign Standard e spiega come accedere alle funzioni chiave e di base. |
| 26 giugno 2020 | [Gestione delle chiavi GPG](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/administrating/control-panel/gpg-key-management/gpg-key-management-overview.html?lang=it) | Campaign Standard/Pannello di controllo | Scopri come generare e installare una coppia di chiavi GPG pubblica/privata per la crittografia dei dati e come importare e installare una chiave pubblica per la decrittografia dei dati. |
...
| Funzione | Descrizione |
| -----------| ---------- |
| GDPR Transparency &amp; Consent Framework | Advertising Cloud aggiornerà il supporto per il Trasparency and Consen Framework di IAB alla versione 2.0 entro il 15 agosto 2020. Al momento, non sono necessarie modifiche da parte del cliente.  In qualità di responsabile del trattamento dati per i clienti, Adobe Advertising Cloud dispone delle funzionalità per l‘adempimento agli obblighi ai sensi del GDPR applicabili all&#39;utilizzo dei relativi prodotti e servizi. |
| Integrazione Audience Manager | (Beta solo per i clienti di Adobe Audience Manager con Adobe Experience Platform) DSP può inviare file di registro utilizzabili contenenti i dati sul coinvolgimento pubblicitario di un inserzionista ad Audience Manager tramite Adobe Experience Platform. In Audience Manager, gli inserzionisti possono utilizzare i dati per la segmentazione avanzata e strumenti approfonditi, come ad esempio i report di Audience Optimization. |
| Targeting basato sulle persone con grafico cross device | I clienti DSP self-service possono utilizzare un grafico del dispositivo (Adobe Device Co-op o LiveRamp) per il targeting basato sulle persone e la gestione della frequenza nelle nuove campagne. In questo modo gli inserzionisti possono raggiungere il pubblico attraverso i propri dispositivi limitando l&#39;esposizione. Inoltre, la modifica in blocco delle impostazioni di targeting tra dispositivi in posizioni diverse è ora in versione beta. Per abilitare la versione beta per il tuo account, contatta il tuo account manager di Adobe. |
| Targeting del sito | Le “blackilist” e le “whitelist” sono state rinominate in termini più equi, “Bloccati (siti)” e “Mirati (siti)”. |
| Annunci Flashtalking | DSP ora inserisce automaticamente le macro di clic per tutti i tag di annunci Flashtalking tramite i flussi di lavoro per la creazione di annunci singoli e in grande quantità di terze parti. |
