...
| Gennaio 2026 | [Risoluzione di problemi di reporting avanzato per Adobe Commerce](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29603) | Nuovi articoli | Scopri come diagnosticare e risolvere i problemi di reporting avanzato in Adobe Commerce. |
...
| Gennaio 2026 | [Errore durante l’abilitazione di Ottimizzazione immagine in Adobe Commerce](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29890) | Nuovi articoli | Scopri come risolvere il problema in cui Ottimizzazione immagine [!DNL Fastly] ([!DNL Fastly] IO) è disabilitato per impostazione predefinita e una notifica invita a contattare [!DNL Fastly] per abilitare l’ottimizzazione delle immagini. |
| Gennaio 2026 | [Il problema di autorizzazione della cartella `var/export` in Adobe Commerce sull&#39;infrastruttura cloud](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29895) | Nuovi articoli | Scopri come risolvere il problema che impedisce l’esportazione dei dati di prodotto a causa di problemi di autorizzazioni dei file sul server nella cartella `var/export/email`. |
