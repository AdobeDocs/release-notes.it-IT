...
|Published|Name|Type|Description|
|---------|----|----|-----------|
|February 2024|[Project link (URL) generated changes when you share an Adobe Analytics workspace](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21698.html?lang=it)|New article| This article offers a solution to the Adobe Analytics issue where a project link changes each time a workspace project link is retrieved in a shared Adobe Analytics workspace. You can use either the newly generated link or the previously generated link for access to the target project.|
...
Watch the [November 2023 Release Overview video](https://experienceleague.adobe.com/docs/events/aemcs-release-update-recordings/2023/2023-11-0.html?lang=it) for a summary of the features added in the 2023.11.0 (November 2023) release. 
-->
...
* [Aggiornamenti delle versioni di Experience Manager as a Cloud Service](https://experienceleague.adobe.com/it/docs/events/aemcs-release-update-recordings/overview)
...
* [Home dell’Aiuto di Dynamic Media Classic](https://experienceleague.adobe.com/it/docs/dynamic-media-classic/using/home)
...
* [Informazioni e assistenza per Experience Manager 6.5](https://experienceleague.adobe.com/it/docs/experience-manager-65/content/implementing/deploying/introduction/platform)
* [Informazioni e assistenza per Experience Manager 6.4](https://experienceleague.adobe.com/it/docs/experience-manager-64)
* [Documentazione di Experience Manager: aggiornamenti recenti](https://experienceleague.adobe.com/it/docs/experience-manager-release-information/aem-release-updates/doc-updates/documentation-updates)
...
|Aprile 2024|[[!DNL Workfront] eventi recenti](https://experienceleague.adobe.com/it/docs/events/workfront-recordings/overview)|Più video |Visualizza tutti i [!DNL Workfront] eventi recenti su Experience League.|
|Aprile 2024|[Tutti i prossimi eventi](https://experienceleague.adobe.com/events/?lang=it)|Video multipli |Visualizza tutti i prossimi eventi su Experience League (tutte le applicazioni).|
