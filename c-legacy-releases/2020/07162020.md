...
* **Aggiornamenti alla documentazione di AEM 6.5.5 Forms**
   ...
   * Nuove funzioni e miglioramenti introdotti nella versione 6.5.5:
      ...
      * [Autenticazione basata su certificato X-509 per i servizi web basati su SOAP nel modello per dati modulo.](https://experienceleague.adobe.com/docs/experience-manager-65/forms/form-data-model/configure-data-sources.html?lang=it#configure-soap-web-services)
   ...
   * Nuove funzioni e miglioramenti introdotti nella versione 6.4.8.1:
      * [Autenticazione basata su certificato X-509 per i servizi web basati su SOAP nel modello per dati modulo.](https://experienceleague.adobe.com/docs/experience-manager-64/forms/form-data-model/configure-data-sources.html?lang=it#configure-soap-web-services)
...
| Funzione | Descrizione |
| -----------| ---------- |
| RGPD Transparency &amp; Consent Framework | Advertising Cloud aggiornerà il supporto per il Trasparency and Consen Framework di IAB alla versione 2.0 entro il 15 agosto 2020. Al momento, non sono necessarie modifiche da parte del cliente.  In qualità di responsabile del trattamento dati per i clienti, Adobe Advertising Cloud dispone delle funzionalità per l‘adempimento agli obblighi ai sensi del RGPD applicabili all&#39;utilizzo dei relativi prodotti e servizi. |
