...
* [[!DNL Campaign]](#ac)
* [[!DNL Target]](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html) (collegamenti alla risoluzione problemi)
...
* [!DNL Target] - [!DNL Target] L’ID della sessione verrà ora aggiunto come parametro dei dati contestuali &quot;a.target.sessionId&quot; nel [!UICONTROL Analytics-for-Target] hit inviato ad Adobe Analytics.
...
Consulta le note sulla versione [!DNL Marketo] di [febbraio 2020](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html) per ulteriori informazioni.
