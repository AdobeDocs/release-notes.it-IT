...
## ![Icona](/assets/ec_appicon_24.png) Nuova documentazione e tutorial {#selfhelp}
...
| [!DNL Adobe Campaign]- Audience Destinations | Video: [modificare la dimensione di targeting di una distribuzione per un pubblico di Platform](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/profiles-and-audiences/audience-destinations/changing-targeting-dimension.html?lang=it) | Scopri come modificare la dimensione di targeting di una distribuzione per un pubblico di Platform al di fuori della tabella del profilo principale in Adobe Campaign Standard. |
