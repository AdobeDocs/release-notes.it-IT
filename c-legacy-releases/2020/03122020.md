...
Consulta [When working with Smart Crop (Utilizzo di Smart Crop)](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/adding-dynamic-media-assets-to-pages.html).
...
| [!DNL Adobe Campaign]- Audience Destinations | Video: [modificare la dimensione di targeting di una distribuzione per un pubblico di Platform](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/profiles-and-audiences/audience-destinations/changing-targeting-dimension.html) | Scopri come modificare la dimensione di targeting di una distribuzione per un pubblico di Platform al di fuori della tabella del profilo principale in Adobe Campaign Standard. |
