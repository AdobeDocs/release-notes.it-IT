...
* È stato corretto un bug che causava il malfunzionamento dei consigli sulle caratteristiche di terze parti per quelle che contengono caratteri di barra verticale (`|`) nel nome (AAM-51635).
