...
* [[!DNL Campaign]](#ac)
* [[!DNL Target]](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html) (collegamenti alla guida di Target)
* [[!DNL Magento]](#magento)
* [[!DNL Marketo]](#marketo)
...
| [Navigazione](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/authoring/navigation.html) | Scopri le nozioni di base per la navigazione in AEM Assets. |
...
Per ulteriori informazioni, consulta le [Note sulla versione](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html) di [!DNL Marketo].
