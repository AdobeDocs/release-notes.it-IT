...
* **AEM6.5.3.0**
AEM 6.5, Service Pack 3.0 (6.5.3.0 rilasciato il 12 dicembre 2019) è un aggiornamento importante che include correzioni di problemi fondamentali per i clienti, introdotte successivamente alla data di disponibilità generale di AEM 6.5 di aprile 2019.
...
* **AEM6.4.7.0**
  ...
  AEM 6.4 Service Pack 7.0 (6.4.7.0 rilasciato il 12 dicembre 2019) è un aggiornamento importante che include correzioni di problemi fondamentali per i clienti, introdotte successivamente alla data di disponibilità generale di AEM 6.4 di aprile 2018.
...
* **App desktop AEM2.0.1.1**

  L&#39;app desktop AEM 2.0.1.1 fornisce un aggiornamento per Single Sign-On con Okta e la possibilità di specificare il percorso dei file temporanei in Preferenze. Con questa versione, il supporto per AEM 6.3.x è stato rimosso per Desktop App 2.x.
...
* **NOVITÀ: AEM as a Cloud Service**
   ...
   * [Introduzione](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/overview/introduction.html)
...
* **Servizio automatizzato di conversione moduli**
  ...
  Il servizio automatizzato di conversione moduli, che consente di convertire automaticamente i moduli PDF in fantastici moduli HTML adatti alla visualizzazione su dispositivi mobili, è stato rilasciato al pubblico il 12 dicembre 2019.

   * [Introduzione](https://docs.adobe.com/content/help/it-IT/experience-cloud/user-guides/home.translate.html)
   * [Configurare il servizio](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/configure-service.html)
   * [Convertire moduli PDF in moduli adattivi](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html)
