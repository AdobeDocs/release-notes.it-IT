...
Consulta le [note sulla versione](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html) di [!DNL Marketo] per informazioni aggiornate.
