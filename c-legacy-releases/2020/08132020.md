...
>[!NOTE]
>
>Iscriviti ad [Adobe Priority Product Update](https://www.adobe.com/subscription/priority-product-update.html?lang=it) (Aggiornamento prioritario sui prodotti Adobe) per ricevere le notifiche via e-mail sulle nuove versioni.
...
| 21 luglio 2020 | [Progetti di traduzione](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/manage-translation-projects.html?lang=it) | Tutorial | Scopri come creare, modificare e gestire un progetto di traduzione per la [!UICONTROL copia in lingua]. |
| 21 luglio 2020 | [Lavori di traduzione](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/manage-translation-projects.html?lang=it) | Tutorial | Scopri come aggiungere un lavoro di traduzione a un progetto di traduzione esistente. |
| 21 luglio 2020 | [Aggiornamento della copia in lingua con Launches](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/updating-language-copy.html?lang=it) | Tutorial | Scopri come aggiornare, revisionare e approvare le modifiche in una [!UICONTROL copia in lingua] con l’aiuto di Launches. |
| 21 luglio 2020 | [Panoramica della gestione multisito](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/language-copy-overview.html?lang=it) | Tutorial | Otteni una panoramica sul processo di creazione di un sito multilingue utilizzando una [!UICONTROL copia in lingua] in [!UICONTROL AEM Sites]. |
...
| 21 luglio 2020 | [Creare una copia in lingua](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/manage-component-inheritance-live-copy.html?lang=it) | Tutorial | Descrizione |
| 21 luglio 2020 | [Creare un progetto di traduzione multilingue](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/create-multinational-translational-project.html?lang=it) | Tutorial | Scopri come creare, modificare e gestire un progetto di traduzione multilingue per la [!UICONTROL copia in lingua] dalla console dei progetti AEM. |
...
| 21 luglio 2020 | [Creare una pagina della copia in lingua](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/create-new-page-language-copy.html?lang=it) | Tutorial | Scopri come creare una pagina in una [!UICONTROL copia in lingua] esistente e tradurre il contenuto in un’altra [!UICONTROL copia in lingua]. |
| 21 luglio 2020 | [Stato del lavoro di traduzione](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/translation-job-status.html?lang=it) | Tutorial | Comprendi i diversi stati associati a un lavoro di traduzione o a un elemento di esso. |
...
| 21 luglio 2020 | [Introduzione all’editor SPA](https://video.tv.adobe.com/v/3410041?quality=12&learn=on&captions=ita) | Tutorial | Introduzione al corso Guida introduttiva all’editor SPA di AEM per sviluppatori. |
