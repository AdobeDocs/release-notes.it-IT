...
| 10 luglio 2020 | [Pannello di controllo Campaign - Gestione chiavi GPG - Utilizzo di una chiave GPG per crittografare i dati](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/administrating/control-panel-acc/gpg-key-management/using-a-gpg-key-to-encrypt-data.html?lang=it) | Campaign Classic | Scopri come esportare i dati utilizzando una chiave GPG installata sul Pannello di controllo Campaign. |
...
| 9 luglio 2020 | [Pannello di controllo Campaign - Gestione chiavi GPG - Utilizzo di una chiave GPG per crittografare i dati](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/administrating/control-panel/gpg-key-management/using-a-gpg-key-to-encrypt-data.html?lang=it) | Campaign Standard | Scopri come esportare i dati utilizzando una chiave GPG installata sul Pannello di controllo Campaign. |
