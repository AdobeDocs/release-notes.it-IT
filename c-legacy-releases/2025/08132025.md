...
| Agosto 2025 | [Adobe Commerce on-premise: installazione di più store senza codici store negli URL](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27235) | Nuovi articoli | Scopri le soluzioni al problema quando imposti una nuova visualizzazione archivio in Adobe Commerce con una struttura URL personalizzata (ad esempio: *www.example.com/dk*) senza abilitare l’impostazione globale **[!UICONTROL Aggiungi codice archivio agli URL]**, il contenuto e il tema vengono visualizzati come previsto, ma nella pagina viene visualizzato un errore *404*. |
