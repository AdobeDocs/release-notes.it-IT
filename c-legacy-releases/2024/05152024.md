...
* **ESPERIENZE DI UTENTI ESPERTI** | Video | _Esperienze per te_ presenta contenuti creati da utenti abituali che hanno raggiunto un certo livello di esperienza e influenza con le loro soluzioni Adobe DX. trova l’ispirazione necessaria per migliorare le tue competenze di prodotto. | [Disponibile on-demand](https://experienceleague.adobe.com/it/docs/experiences-by-you/experiences-by-you/overview)
...
Attenzione a tutti i candidati per le certificazioni Adobe! Visita il sito [Certificazione](https://https://experienceleague.adobe.com/it/docs/certification/program/overview) di Experience Cloud su Experience League.

+++Dettagli

Il sito [Certificazione di Experience Cloud](https://https://experienceleague.adobe.com/it/docs/certification/program/overview) è un punto di riferimento per tutti i [!DNL Experience Cloud]contenuti relativi alla certificazione di e viene aggiornato regolarmente con:

* Certificazioni disponibili
* Rinnovi delle certificazioni per le applicazioni Adobe
* Aggiornamenti dei programmi di certificazione

E altro ancora! Vai a [Certificazione Adobe](https://https://experienceleague.adobe.com/it/docs/certification/program/overview) su Experience League e inizia il percorso di certificazione oggi stesso!
