...
| Pubblicato | Nome | Tipo | Descrizione | Applicazioni |
| -----------| ---------- | ---------- | ---------- |---------- |
| Settembre 2022 | [Configurare gli SMS per Adobe Campaign](https://experienceleague.adobe.com/?lang=it&recommended=Campaign-A-1-2022.classic.setupsms&amp;lang=it) | Corso | Scopri come collegare la tua istanza Campaign al tuo provider SMTP e come analizzare e risolvere i problemi di configurazione. | Campaign Classic v7 |
...
| Pubblicato | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |
| Settembre 2022 | [Corsi su Workfront](https://experienceleague.adobe.com/?lang=it&recommended=Workfront-A-1-2022.1.admin&amp;lang=it) | Corsi | Consulta i nuovi corsi disponibili per Workfront su Experience League. |
