...
| Gennaio 2022 | [Servizio e-mail](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/networking/examples/email-service.html?lang=it) | Video | Invia e-mail da AEM come Cloud Service configurando `DefaultMailService` di AEM per utilizzare porte di uscita di rete avanzate. | AEM as a Cloud Service |
