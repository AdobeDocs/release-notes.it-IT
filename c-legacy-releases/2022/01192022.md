...
* [Documentazione del prodotto di Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-landing.html?lang=it)
...
## Guide all&#39;Experience Manager {#xml-doc}
...
* Per informazioni sulla versione corrente, consulta [Note sulla versione di Target](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html?lang=it).
