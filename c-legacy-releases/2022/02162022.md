...
Pronti per iniziare? [Vinci con un quiz di 5 minuti](https://exploreadobe.com/experience-league-quiz/)
...
## ![Icona](/assets/ec_appicon_24.png) Guide all&#39;Experience Manager {#xml-doc}

Experience Manager Guide è un’applicazione distribuita su AEM. Si tratta di una potente soluzione di gestione dei contenuti per componenti di livello aziendale (CCMS) che consente il supporto DITA nativo in Adobe Experience Manager, permettendo ad AEM di gestire la creazione e la distribuzione di contenuti basati su DITA.
...
### Nuove esercitazioni per le guide di Experience Manager {#tutorials-xml-doc}

Nuovi video, esercitazioni o corsi pubblicati per Experience Manager Guide .

| Data di pubblicazione | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |
| Gennaio 2022 | [Versioni della documentazione XML](https://experienceleague.adobe.com/docs/experience-manager-xml-documentation-learn/tutorials/release-info/latest-release-info.html?lang=it) | Video | Informazioni su Experience Manager Guide, una potente soluzione di gestione dei contenuti per componenti di livello enterprise (CCMS). Abilita il supporto DITA nativo in Adobe Experience Manager, consentendo ad AEM di gestire la creazione e la distribuzione di contenuti basati su DITA. |
