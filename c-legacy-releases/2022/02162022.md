---
title: Note sulla versione centrale - Febbraio 2022
...
* **Webinar Experience Manager GEMS: _Creare siti più rapidamente con Experience Manager Headless e App Builder_**
  ...
  **Ora**: 8:00 (PST) o 5:00 (CET) o 9:00 (IST)
...
| ------| ----- | -----| ------ | --- |
| Febbraio 2022 | [Nozioni di base sulla gestione dei dati con i flussi di lavoro Adobe Campaign](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/data-management/data-management-fundamentals.html?lang=it) | Video | Scopri le dimensioni targeting e le tabelle di lavoro e come Adobe Campaign gestisce i dati tra diverse origini dati. | Campaign v8 |
