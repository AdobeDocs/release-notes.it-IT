...
| -----------| ---------- | ---------- | ---------- |---------- |
| Giugno 2022 | [Introduzione a Real-time CDP per gli amministratori](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-A-1-2022.1.rtcdp)  | Corso | Ottieni un’introduzione alle attività di amministrazione necessarie per iniziare a utilizzare [!DNL Real-time Customer Data Platform]. Scopri la gestione degli utenti e come impostare connessioni con altri partner e sistemi. | [!DNL Real-time CDP] |
