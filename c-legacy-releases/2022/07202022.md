...
| [!UICONTROL Campagne], [!DNL Advanced Campaign Management], [!UICONTROL Rapporti] | (Versione del 16 luglio) (Campagne [!DNL Google Ads] e [!DNL Microsoft Advertising]). Il seguente supporto è ora disponibile per gli annunci di ricerca responsive:<ul><li>La vista [!UICONTROL Annunci] mostra ora le anteprime degli annunci per la ricerca responsive.</li><li> (Dal 20 giugno) È ora possibile creare varianti dinamiche di annunci di ricerca responsive utilizzando un modello di annunci specifico per un motore di ricerca in base al contenuto del proprio inventario, da [!UICONTROL Campagne] > [!UICONTROL Avanzate (ACM)].</li><li>La [!UICONTROL Rapporto sulla variazione dell’annuncio] include due nuove colonne personalizzate: &quot;[!UICONTROL Titoli creativi],&quot; che aggiunge una colonna per ciascuno dei titoli dell’annuncio (&quot;[!UICONTROL Titolo creativo]&quot; attraverso &quot;[!UICONTROL Titolo creativo15]&quot;) e &quot;[!UICONTROL Descrizioni],&quot; che aggiunge una colonna per ciascuna delle righe di descrizione dell’annuncio (&quot;[!UICONTROL Descrizione1]&quot; attraverso &quot;[!UICONTROL Descrizione4]&quot;). Quando includi queste colonne, non devi includere le altre colonne Titolo creativo e Descrizione .</li></ul> |
