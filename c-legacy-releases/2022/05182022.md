...
| Maggio 2022 | [Analizzare e visualizzare informazioni omni-channel in Tableau utilizzando Query Service](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/analyze-and-visualize.html?lang=it) | Video | Scopri come utilizzare Adobe Experience Platform Query Service con strumenti di visualizzazione dati esterni utilizzando un esempio di analisi di abbandono. | Experience Platform |
...
| Maggio 2022 | [Aggiornamenti nella pagina di destinazione di Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/analysis-workspace-basics/analysis-workspace-landing-page-updates.html?lang=it) | Video | Scopri alcuni dei miglioramenti e delle aggiunte apportate alla nuova pagina di destinazione. Abbiamo preso il tuo feedback dai clienti e abbiamo cercato di incorporare le funzioni più importanti come il ridimensionamento delle colonne, nuovi tipi di colonne, collegamenti a rapporti in tempo reale e bot e molti altri. |
...
| Data di pubblicazione | Nome | Tipo | Descrizione | Applicazione |
| -----------| ---------- | ---------- | ---------- |---------- |
| Maggio 2022 | [Condivisione dell’accesso all’account](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/advanced-tasks-admins/share-account-access.html?lang=it) | Video | Scopri come impostare l’accesso in sola visualizzazione alle transazioni nel conto di un altro utente. | [!DNL Acrobat Sign] |
