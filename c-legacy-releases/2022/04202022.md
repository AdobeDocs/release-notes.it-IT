...
| Integrazione con Adobe Analytics | (7 aprile) Nel feed di dati che Advertising Cloud invia a [!DNL Analytics], i dati per gli annunci di ricerca responsivi (RSA, responsive search ads) di [!DNL Google Ads] e [!DNL Microsoft Advertising] che ricevono pochi clic sono riclassificati con [!UICONTROL Ad Type] impostato su “[!UICONTROL Responsive Search Ads]”. In precedenza, i dati venivano inclusi con [!UICONTROL Ad Type] impostato su “[!UICONTROL Text Ads]”. Gli RSA nelle campagne inattive non verranno riclassificati.<br><br>Inoltre, il valore [!UICONTROL Responsive Ad Title] ora viene compilato con il primo titolo, mentre [!UICONTROL Responsive Ad Description] viene compilato con la prima descrizione. |
