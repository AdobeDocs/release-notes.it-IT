...
| ------| ----- | ------ | ------ |-----|
| Aprile 2022 | [Generazione di documenti tramite l’API di comunicazione](https://experienceleague.adobe.com/?lang=it&recommended=ExperienceManager-D-1-2022.3.formscs&amp;lang=it) | Corso | Unisci i dati con il modello xdp richiamando gli endpoint HTTP di Forms CS. | AEM Forms |
