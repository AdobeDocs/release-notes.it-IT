...
| Pubblicato | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |
| Aprile 2021 | [Real-time CDP per gli utenti di Audience Manager](https://experienceleague.adobe.com/?lang=it&recommended=AudienceManager-U-1-2020.1.rtcdp&amp;lang=it) | Corso | I clienti di Audience Manager stanno trasformando la gestione dei contenuti passando ad Adobe Real-time Customer Data Platform (Real-time CDP). Con un approccio concetto per concetto, questo corso aiuta gli utenti di Audience Manager a comprendere come tali concetti vengono gestiti in Real-time CDP. |
