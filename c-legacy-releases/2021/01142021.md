...
| 22 dicembre 2020 | [Creare segmenti con più entità](https://experienceleague.adobe.com/docs/platform-learn/tutorials/segments/create-multi-entity-segments.html?lang=it) | Video | Scopri come generare segmenti multi-entità nel Generatore di segmenti di Adobe Experience Platform. |
...
| Pubblicato | Nome | Soluzione | Descrizione |
| ----------- | ----------- | ---------- | ---------- |
| 14 novembre 2020 | [Creare dashboard di Advertising con Adobe Analytics](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/analytics/analytics-dashboards-a4adc.html) | Video | Tecniche per creare una dashboard di Advertising per il monitoraggio delle campagne in tempo reale. |
...
| 14 novembre 2020 | [Creare segmenti di Analytics per attivazione e reporting](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/analytics/analytics-segments-a4adc.html#analytics) | Video | Utilizzo di dimensioni Advertising per creare segmenti per reporting e analisi più nitidi. |
