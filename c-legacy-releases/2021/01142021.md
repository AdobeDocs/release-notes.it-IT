...
Hai bisogno di aiuto? Visita [ Experience League](https://experienceleague.adobe.com/?lang=it#home) per trovare documentazione tecnica e sui prodotti, corsi curati da Adobe, esercitazioni video, risposte rapide, insight sulla community e corsi di formazione tenuti da istruttori. Il contenuto è stato spostato in questa posizione da `experienceleague.adobe.com`. Aggiornare di conseguenza i segnalibri.
...
| 26 ottobre 2020 (aggiornato) | [Acquisire dati utilizzando il connettore sorgente del sistema CRM di Salesforce](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-crm.html?lang=it) | Video | Il connettore di origine CRM Salesforce ti consente di eseguire facilmente il batch di acquisizione dei dati da CRM Salesforce a Adobe Experience Platform Real-time Customer Profile and Experience Data Lake, in modo semplice e scalabile. |
| 13 ottobre 2020 (aggiornato) | [Acquisire dati utilizzando il connettore di sorgente del sistema CRM di Salesforce](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics.html?lang=it) | Video | Il connettore di origine CRM Salesforce ti consente di eseguire facilmente il batch di acquisizione dei dati da CRM Salesforce a Adobe Experience Platform Real-time Customer Profile and Experience Data Lake, in modo semplice e scalabile. |
...
* **Experience Manager as a Cloud Service**
   ...
   * **Adobe Experience Manager Assets as a Cloud Service**
      ...
      * Experience Manager è stato migliorato per tenere traccia e visualizzare i riferimenti alle risorse quando una risorsa viene utilizzata in una distribuzione remota Experience Manager Sites tramite la funzionalità [!UICONTROL Risorse collegate]. Nuovo [!UICONTROL Riferimenti] scheda della risorsa [!UICONTROL Proprietà] In questa pagina sono ora elencati i riferimenti locali e remoti della risorsa. I riferimenti consentono agli utenti DAM di monitorare l’utilizzo delle risorse nelle pagine [!UICONTROL Sites] e nelle risorse composte in [!UICONTROL Risorse].
