...
| Navigazione di Experience Cloud [!UICONTROL Triggers] | [Experience Cloud Triggers](https://experienceleague.adobe.com/docs/core-services/interface/services/triggers.html) è disponibile per la navigazione diretta dallo switcher dell’applicazione nell’intestazione per gli utenti con provisioning. |
...
* [Nuove funzioni nel Customer Journey Analytics](#cust-journey) **Aggiornato il 7 ottobre 2021**
