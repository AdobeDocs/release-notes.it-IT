...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * Gli amministratori possono configurare Experience Manager in modo da eliminare l’origine delle risorse dopo il loro inserimento in blocco. Consulta [Inserimento in blocco di risorse](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/add-assets.html#asset-bulk-ingestor).
...
Consulta le [!DNL Marketo Engage] [note sulla versione](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html) per informazioni aggiornate sulla pianificazione.
