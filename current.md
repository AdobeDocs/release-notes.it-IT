...
* [[!DNL Adobe Analytics]](#analytics) **(Versione del 13 settembre)**
...
* [Adobe di vulnerabilità relative alla sicurezza dei prodotti](https://helpx.adobe.com/it/security.html)
...
* **[!DNL COMMERCE]** | Webinar | _Preparazione della stagione di picco_ | **14 settembre alle 13:00 CET** | [Registrati](https://register.gotowebinar.com/register/1649826426335413079?source=ExL)

* **[!DNL WORKFRONT]** | Chat domande e risposte | _Ask the Experts: Skill Exchange Grow Track_ | **15 settembre alle 10:00 MT** | [Registrati](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,PiX3iDTmREqs2eOICcUIoA,5KJVGb6S_Uiiki7ErNALgw,ti9YHZqvVUyqJ5ooYWQSYQ,Vc_WBSS-uEGcM_vITdto1A,QitJ7x6tM0GLC9Ahpcgblg?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **[!DNL WORKFRONT]** | Workshop per i clienti | _Admin 101 - Guida introduttiva a Workfront_ | **19 settembre alle 10:00 (ora legale del Pacifico)** | [Registrati](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,ro1ksXUe10a6IwM8fXCIHg,-FBAvqy1W0aUZDRPXCzn3A,JaIpLTwA3E2wq1vRimwKjQ?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **[!DNL EXPERIENCE MANAGER AS A CLOUD SERVICE]** | AEM GEMS | _Sfruttare la potenza di New Relic APM per AEM as a Cloud Service_ | **20 settembre alle 8:00 PT** | [Registrati](https://aem-augs.adobe.com/events/details/adobe-experience-manager-aem-learning-chapter-presents-harness-the-power-of-new-relic-apm-for-aem-as-a-cloud-service-boost-performance-amp-issue-resolution/)

* **[!DNL WORKFRONT]** | Chat domande e risposte | _Pannello clienti: vantaggi e best practice con Fusion_ | **26 settembre alle 11:00 (ora legale del Pacifico)** | [Registrati](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,wwMNpBFpyU6JRZ7t-hkIIQ,SV8DFIlim0ivqJp7uYE5zg,-iWPFBz0s0aNbozaOGyGsQ?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **[!DNL EXPERIENCE MANAGER SITES]** | Impara dai tuoi colleghi | _Approfondimento degli strumenti in AEM Sites_ | **28 settembre alle 8:00 PT** | [Registrati](https://engage.adobe.com/AEM_Tools_Deep_Dive_Registration.html?utm_source=ExL)

* **[!DNL WORKFRONT]** | Impara dai tuoi colleghi | _Approfondimento degli strumenti in AEM Sites_ | **28 settembre alle 8:00 PT** | [Registrati](https://engage.adobe.com/AEM_Tools_Deep_Dive_Registration.html?utm_source=ExL)

* **[!DNL WORKFRONT]** | Evento comunitario | _Connect: Chat con gli amministratori per marketing e creatività_ | **6 ottobre alle 10:00 MT** | [Registrati](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,1qnTSsu1BE6bJ4ijFsYafg,COdPeWL3z0qsME9nhjnRwg,GEPFgV3sAkazC0HNeX4Qiw,MfXhfQkRaEeNxpVhAjrevw,etCOBCAjk0iAVD0DNRskXQ?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **[!DNL WORKFRONT]** | Workshop per i clienti | _Admin 101: come consentire agli utenti di utilizzare Workfront_ | **17 ottobre alle 9:00 MT** | [Registrati](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,1qnTSsu1BE6bJ4ijFsYafg,COdPeWL3z0qsME9nhjnRwg,omfk3au070S9BM8uw0Q-eQ,hQB5-0lLTEqbiy3szpaQ7Q,IAorw9UUG0Kzb9zZNhCeEA?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
Per gli aggiornamenti recenti delle funzioni, consulta:
...
| ----------| ---------- | ---------- | ---------- |---------- |
| Settembre 2023 | Privacy Service | [Introduzione a Privacy Service](https://experienceleague.adobe.com/docs/platform-learn/tutorials/privacy/introduction-to-privacy-services.html?lang=en) | Video multipli | Scopri le normative sulla privacy e i loro effetti sulle operazioni relative ai dati. Inoltre, scopri come [!UICONTROL Privacy Service] gestisce queste sfide. Guarda gli ultimi video nella sezione Privacy e sicurezza del [!DNL Experience Platform] esercitazioni. |
| Settembre 2023 | Amministrazione | [Configurare il controllo degli accessi basato su attributi](https://experienceleague.adobe.com/docs/platform-learn/tutorials/admin/configure-attribute-based-access-control.html?lang=it) | Video | Scopri come configurare il controllo degli accessi basato su attributi per limitare l’accesso a specifici [!DNL Experience Platform] risorse. |
...
Trova le esercitazioni più recenti per [!DNL Real-Time Customer Data Platform] su Experience League.
...
Le note sulla versione di settembre coprono il periodo di rilascio dal 13 settembre 2023 al 3 ottobre 2023. Le versioni di Adobe Analytics funzionano su [modello di consegna continua](https://experienceleague.adobe.com/docs/analytics/release-notes/releases.html?lang=en), che consente un approccio più scalabile e graduale alla distribuzione delle funzioni. Di conseguenza, queste note sulla versione vengono aggiornate diverse volte al mese. Consultale regolarmente.

## Nuove funzioni o miglioramenti {#features}

| Funzione | Descrizione | [Avvio del rollout](https://experienceleague.adobe.com/docs/analytics/release-notes/releases.html) | [Disponibilità generale](https://experienceleague.adobe.com/docs/analytics/release-notes/releases.html) |
| ----------- | ---------- | ------- | ---- |
...
* [Note sulle versioni precedenti 2022](https://experienceleague.adobe.com/docs/analytics/release-notes/previous/2022.html?lang=en)
...
| Data di pubblicazione | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |
| Settembre 2023 | [Sblocco di informazioni con istogrammi: oltre le medie in Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/unlocking-insights-with-histograms.html?lang=en) | Video | Scopri l’impatto degli istogrammi nell’analisi per informazioni che vanno oltre le medie. Gli istogrammi rivelano pattern di dati nel comportamento del cliente, nel coinvolgimento dei visitatori, nelle prestazioni tecniche e negli errori di modulo, consentendo di ottenere informazioni più approfondite e decisioni informate in Adobe Workspace. |
| Settembre 2023 | [Collegamento interno o esterno al progetto](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/linking-inside-or-outside-of-your-project.html) | Video | Scopri come creare collegamenti interni o esterni nel tuo [!UICONTROL Analysis Workspace] progetto. |
| Settembre 2023 | [Utilizzare le dimensioni nelle metriche calcolate](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/calculated-metrics/using-dimensions-in-calculated-metrics.html) | Video aggiornato | Scopri come utilizzare le dimensioni in [!UICONTROL metrica calcolata] generatore. Possono essere aggiunte a qualsiasi [!UICONTROL metrica calcolata] formula per limitare la nuova metrica a una dimensione o a un valore di dimensione. |
...
| Data di pubblicazione | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |
| Settembre 2023 | [Utilizzare il dizionario dati](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/components/data-dictionary/use-data-dictionary.html) | Video | Scopri di più su [!UICONTROL Dizionario dati] in Analysis Workspace per Customer Journey Analytics. |
| Settembre 2023 | [Panoramica di Analysis Workspace](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/workspace-projects/analysis-workspace-overview.html) | Video | Scopri i componenti di base per la creazione di progetti e dashboard in Analysis Workspace, un ambiente di analisi flessibile e a forma libera utilizzato per esplorare e visualizzare i dati di Experienci Platform. |
| Settembre 2023 | [Generare un nuovo progetto in Analysis Workspace](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/workspace-projects/build-a-new-project.html) | Video | Scopri come creare un progetto di base in Analysis Workspace per [!DNL Customer Journey Analytics]. |
...
La clientela esistente può continuare a utilizzare la propria implementazione di [!DNL DIL]. Tuttavia, Adobe non sviluppa [!DNL DIL] oltre questo punto. I clienti sono incoraggiati a valutare [Experienci Platform Web SDK](https://experienceleague.adobe.com/docs/experience-platform/edge/home.html?lang=it) per la strategia di raccolta dei dati a lungo termine. La clientela che desidera implementare nuove integrazioni di raccolta dati dopo luglio 2023 deve utilizzare [Experience Platform Web SDK](https://experienceleague.adobe.com/docs/experience-platform/edge/home.html?lang=it).
...
* [Aggiornamenti e roadmap delle versioni di Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/home.html?lang=it) - Scopri la roadmap delle versioni di Experience Manager, gli aggiornamenti sulle versioni precedenti e gli aggiornamenti della documentazione.
...
Guarda il [video di panoramica sulla versione di agosto 2023](https://experienceleague.adobe.com/docs/events/aemcs-release-update-recordings/2023/2023-8-0.html) per un riepilogo delle funzioni aggiunte nella versione 2023.08.0 (agosto 2023). 

### [!DNL Experience Manager Sites] as a [!DNL Cloud Service]

_Nuove funzioni_

* Il [Console Frammenti di contenuto](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/administering/content-fragments/managing.html?lang=en) ora consente agli utenti di visualizzare i tag e di effettuare ricerche per tag applicati come metadati ai frammenti di contenuto. Per usufruire di questa funzionalità, gli utenti non devono più passare all’interfaccia utente di Assets, riducendo il passaggio da un contesto all’altro e migliorando l’efficienza.
...
* La visualizzazione dei riferimenti principali aiuta gli autori a comprendere l’impatto della loro modifica.
...
* **Importare risorse in blocco da origini dati** - Ora gli amministratori possono [importa molte risorse](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/assets-view/bulk-import-assets-view.html?lang=en) da un’origine dati ad AEM Assets. Gli amministratori non devono più caricare singole risorse o cartelle in AEM Assets. Le origini dati supportate per l’importazione in blocco includono Azure, AWS, Google Cloud e Dropbox.
* **Strumenti di modifica delle immagini basati su Adobi Express** - Semplice e intuitivo [strumenti di modifica delle immagini basati su Adobi Express](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/assets-view/edit-images-assets-view.html?lang=en) disponibile direttamente in AEM Assets per aumentare il riutilizzo dei contenuti e accelerarne la velocità.
* **Flessibilità durante l&#39;inserimento di elementi nell&#39;area di lavoro Accesso rapido** : possibilità di selezionare e fissare gli elementi per l’organizzazione o per un elenco di gruppi in modo che vengano visualizzati nell’ [Sezione Accesso rapido della mia area di lavoro](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/assets-view/my-workspace-assets-view.html?lang=en).

_Nuove funzioni nella visualizzazione Amministratore_

* Ora gli amministratori possono [configurare la dimensione batch delle risorse](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/search-assets.html?lang=en#configure-asset-batch-size) che vengono visualizzati quando si esegue una ricerca. I risultati della ricerca delle risorse vengono visualizzati in multipli del numero di dimensioni del batch configurato quando scorri ulteriormente verso il basso per caricare i risultati. Puoi scegliere tra le dimensioni disponibili del batch (200, 500 e 1000 risorse). Impostando un numero di dimensioni batch più basso si ottengono tempi di risposta della ricerca più rapidi.
* Experience Manager Assets ora include una nuova versione 9 del `damAssetLucene` indice. `damAssetLucene-9` modifica il comportamento del conteggio dei facet di query Oak in [non valuta più il controllo degli accessi sui conteggi facet](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/search-assets.html?lang=en) restituito dall&#39;indice di ricerca sottostante, che determina tempi di risposta della ricerca più rapidi.

_Nuove funzioni nel canale prerelease_

* **Dynamic Medie** - [Supporto per sottotitoli multipli e tracce audio nei video](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/dynamicmedia/video.html?lang=en#about-msma). In entrata [!DNL Dynamic Media], è ora possibile aggiungere facilmente più sottotitoli e tracce audio a un video principale. Grazie a questa funzionalità, i video sono accessibili a un pubblico globale. Puoi personalizzare un singolo video principale pubblicato per un pubblico globale in più lingue e rispettare le linee guida sull’accessibilità per diverse aree geografiche. Gli autori possono anche gestire i sottotitoli e le tracce audio da una singola scheda nell’interfaccia utente.
* **Risorse** - Possibilità di selezionare archivi ZIP gestiti in Experience Manager e [estrazione diretta dei file in Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/manage-digital-assets.html?lang=en#extract-zip-archives) senza scaricarli.
...
* **Adobe Analytics con Experience Cloud Setup Automation per Forms** - È ora possibile abilitare Adobe Analytics con Experience Cloud Setup Automation con la selezione di un paio di pulsanti. Consente di connettersi [!DNL AEM Forms as a Cloud Service] con tag Experienci Platform e Adobe Analytics per acquisire e tenere traccia delle metriche delle prestazioni per i moduli pubblicati.
* **Modello di rapporto Adobe Analytics per Adaptive Forms** - [!DNL Forms as a Cloud Service] ora fornisce un rapporto di Adobe Analytics pronto all’uso. Consente di comprendere facilmente le prestazioni dei moduli. Le metriche a livello di modulo forniscono informazioni approfondite sulle prestazioni del modulo per più indicatori di prestazioni chiave (KPI, Key Performance Indicator), come rappresentazioni, visitatori, invii e tempo medio di riempimento. Monitorando il comportamento degli utenti e i feedback ricevuti, è possibile identificare le aree del modulo che causano confusione e guidare i miglioramenti alla progettazione e alle funzionalità del modulo.
* [[!UICONTROL Frammenti di modulo] in [!UICONTROL Forms adattivo] basato su Componenti core](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/adaptive-form-fragments-core-components.html?lang=en) - Dire addio alla duplicazione, ottimizzare l&#39;inventario digitale e migliorare la collaborazione migliorando l&#39;esperienza di creazione di moduli con [!UICONTROL Frammenti di modulo]. Questi componenti riutilizzabili si integrano perfettamente in più moduli, semplificando la creazione di moduli coerenti e dall’aspetto professionale. [!UICONTROL Frammenti di modulo] garantire riutilizzabilità, standardizzazione e coerenza del brand tramite _cambiare una volta e riflettere ovunque_ funzionalità. Aumenta la manutenibilità e l’efficienza, poiché gli aggiornamenti apportati in un’unica posizione vengono propagati automaticamente in tutti i moduli che utilizzano questi frammenti.
* [Passaggio del flusso di lavoro Acrobat Sign migliorato](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/create-form-centric-workflows/aem-forms-workflow-step-reference.html?lang=en#sign-document-step-sign-document-step) - Il [!DNL Acrobat Sign] Il passaggio del flusso di lavoro è stato migliorato per includere quanto segue:

   * **Autenticazione basata su documento ufficiale per Acrobat Sign** - Acrobat Sign Government ID-Based Authentication offre un ulteriore livello di verifica consentendo agli utenti di autenticare la propria identità utilizzando gli ID governativi (patente di guida, carta d&#39;identità, passaporto). Utilizzando documenti di identificazione attendibili, questo miglioramento aggiunge un ulteriore livello di affidabilità al processo di firma, rendendolo ideale per scenari che richiedono maggiore sicurezza, conformità e convalida degli utenti.
   * **Audit Trail per documenti Acrobat Sign** : utilizza la funzione Audit Trail per ottenere informazioni dettagliate sul ciclo di vita dei documenti Acrobat Sign. Con Audit Trail è ora possibile mantenere un registro completo di tutte le azioni e interazioni relative ai documenti. Questo record include dettagli quali chi ha visualizzato, modificato o firmato il documento, oltre a marche temporali per ogni evento. Questo miglioramento dei record è fondamentale per mantenere la conformità, risolvere le controversie e garantire l’integrità degli accordi digitali.
   * **Nuovi ruoli per i destinatari del contratto oltre al solo firmatario** - Adobe Acrobat Sign consente ora di espandere i ruoli dei destinatari del contratto oltre a Firmatario per soddisfare meglio i requisiti del flusso di lavoro. Quando questa opzione è abilitata, ogni destinatario di un contratto ha il proprio ruolo configurabile singolarmente, con Firmatario come impostazione predefinita.

* [Protect i tuoi documenti con le API Document Assurance (parte delle API di comunicazione)](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction.html?lang=en#document-assurance-doc-assurance) - Le API Document Assurance consentono di proteggere le informazioni riservate firmando e crittografando i documenti. Tramite la crittografia, il contenuto di un documento viene trasformato in un formato illeggibile, in modo che solo gli utenti autorizzati possano accedervi. Questo strato di protezione fortificato non solo protegge i dati preziosi da occhi non autorizzati, ma offre anche la massima tranquillità. Le API di firma consentono all’organizzazione di proteggere la sicurezza e la privacy dei documenti Adobe PDF che distribuisce e riceve. Questo servizio utilizza firme digitali e certificazione per garantire che solo i destinatari desiderati possano modificare i documenti.
* **Supporto del conteggio delle pagine nelle API di comunicazione** - Ora, oltre a recuperare il documento tramite le API di comunicazione, è possibile ricevere anche le informazioni importanti sul numero di pagine contenute nel documento.
* [Gestione degli errori con gestori degli errori personalizzati nell’editor di regole](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/add-custom-error-handler-adaptive-forms-core-components.html?lang=en) - È ora possibile richiamare una funzione personalizzata in risposta a un errore restituito da un servizio esterno e fornire una risposta personalizzata agli utenti finali. Ad esempio, puoi richiamare un flusso di lavoro personalizzato nel back-end per codici di errore specifici oppure informare la clientela che il servizio non è disponibile.
...
* sfrutta la potenza di AEM Forms
...
* **Registri CDN** : scarica i registri CDN da Cloud Manager, utile per ottimizzare il rapporto cache-hit e migliorare la visibilità del flusso di distribuzione dei contenuti. Scopri il formato di registro CDN. Questa funzione è stata progettata per essere implementata dai primi di settembre.
...
* Durante la configurazione di un set di contenuti su [copia contenuto, configurazioni in base al contesto](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developing/configurations.html?lang=en) sono ora consentiti nei set di contenuti nell’interfaccia utente.
...
* **Ripristino del contenuto self-service** - [Una nuova funzione di ripristino self-service dei contenuti](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/operations/restore.html?lang=en) ora fornisce il ripristino del backup per un massimo di sette giorni ed è disponibile per gli utenti che lo adottano per la valutazione, con:

   * Ripristino del backup point-in-time per le 24 ore precedenti.
   * Ripristini a tempo fisso fino a sette giorni.

  Se ti interessa testare questa nuova funzione e condividere i tuoi commenti, invia un’e-mail a [aemcs-restorefrombackup-adopter@adobe.com](mailto:aemcs-restorefrombackup-adopter@adobe.com) dall’e-mail associata al tuo Adobe ID. Tieni presente quanto segue:
...
* **Dashboard di audit dell’esperienza** - [Dashboard di Cloud Manager Experience Audit](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/experience-audit-dashboard.html) include una visualizzazione con tendenze dei punteggi di prestazioni della pagina, oltre a informazioni approfondite e consigli per aiutarti a migliorarli. L’audit dell’esperienza è incluso come passaggio nella pipeline di produzione di Cloud Manager.
  ...
  Ti interessa testare il nuovo cruscotto? Invia un messaggio e-mail a [aem-lighthouse-pilot@adobe.com](mailto:aem-lighthouse-pilot@adobe.com) puoi iniziare dal tuo indirizzo e-mail associato al tuo Adobe ID e Adobe.
...
* [Una riesecuzione della pipeline](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/deploy-code.html?lang=en#reexecute-deployment) non è più consentito se l’esecuzione precedente non ha un commitId impostato sullo stato della fase di build.
* Ora viene visualizzato un messaggio più comprensibile per i rari errori quando un utente seleziona una pipeline nelle schermate Attività o Pipeline.
* Il `contentSetName` il valore non è più mancante nei registri ed è ora fornito negli input quando si avvia un [copia contenuto](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developer-tools/content-copy.html?lang=it) operazione.
...
* Quando un certificato scade, i nomi di dominio e gli elenchi di IP consentiti associati al certificato non verranno più rimossi dalla rete CDN.
   * In questi casi, il sito continua ad essere raggiungibile.
   * Il [Interfaccia utente di Cloud Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-ssl-certificates/introduction.html?lang=it) fornisce avvisi più visibili sull’imminente scadenza del certificato SSL.
...
La data di rilascio dell’ultima versione 1.9.12 di Workfront per il connettore ottimizzato di Experience Manager è il 9 agosto 2023.

_Punti salienti della versione_

* La versione più recente del connettore ottimizzato di Workfront for Experience Manager include i seguenti aggiornamenti:
...
* [Experience Manager as a Cloud Service 2023.8.0 - Aggiornamento sulla versione](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/aem-as-a-cloud-service-2023-8-0-release-update/ba-p/616365).
* [AEM Community Lens 7a edizione, agosto 2023](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/adobe-experience-manager-community-lens-7th-edition-august-2023/ba-p/614084).
* [Utenti AEM - Condividi il tuo feedback su Gartner Peer Insights!](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-experience-manager-users-share-your-feedback-on-gartner/td-p/613702)
...
| Data di pubblicazione | Applicazioni | Nome | Tipo | Descrizione |
| ----------| ---------- | ---------- | ---------- |---------- |
| Settembre 2023 | AEM Foundation | [Utilizzare ModSecurity per proteggere il sito AEM dagli attacchi DoS](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/security/modsecurity-crs-dos-attack-protection.html) | Video | Scopri come abilitare ModSecurity per proteggere il tuo sito dagli attacchi Denial of Service (DoS) utilizzando il set di regole di base ModSecurity (CRS) OWASP nel Dispatcher di pubblicazione Adobe Experience Manager (AEM). |
| Settembre 2023 | AEM Foundation | [Utilizzare la procedura guidata SSL nell’AEM](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/security/use-the-ssl-wizard.html) | Video | Scopri come impostare SSL in Adobe Experience Manager per eseguirlo su HTTPS utilizzando la procedura guidata SSL integrata. |
| Settembre 2023 | AEM Forms | [Registra il valore delle variabili nel flusso di lavoro AEM](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/variables-aem-workflow/part6.html%3Flang%3Dit) | Articolo | Registra il valore delle variabili del flusso di lavoro AEM. Questo aiuta gli sviluppatori a tenere traccia e comprendere come viene eseguito un flusso di lavoro AEM, diagnosticare i problemi e monitorare il flusso di dati all’interno di un flusso di lavoro AEM. |
| Settembre 2023 | AEM Forms | [Archivia gli invii di moduli nell’archiviazione Azure](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/some-useful-integrations/store-form-data-in-azure-storage.html?lang=en) | Video | Scopri come effettuare chiamate REST per archiviare i dati AEM Forms inviati nell’archiviazione di Azure. |
| Settembre 2023 | AEM CS | [Asset-share-commons-3.4.0](https://github.com/adobe/asset-share-commons/releases/tag/asset-share-commons-3.4.0) | Esempio di codice | Il rilascio di Asset Share Commons v3.4.0 fa riferimento all’implementazione di Asset Share con correzioni di bug e aggiornamenti delle vulnerabilità. |
| Settembre 2023 | AEM Foundation | [Chiamata delle API interne con certificati privati](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/security/call-internal-apis-having-private-certificate.html) | Articolo | Scopri come effettuare chiamate HTTPS da AEM alle API web utilizzando certificati privati o autofirmati. |
| Settembre 2023 | AEM Sites | [Avvii](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/page-authoring/launches.html?lang=it) | Video aggiornato | [!UICONTROL Lanci] in [!DNL AEM Sites] fornire un modo per creare, scrivere e rivedere i contenuti per le versioni future. |
...
| Data di pubblicazione | Nome | Tipo | Descrizione |
|---------|--------|---------|---------|
| Agosto 2023 | [Impossibile selezionare [!DNL Adobe Target] as the Cloud solution for an [!DNL IMS] configurazione](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22693.html?lang=it) | Nuovo articolo | Scopri la soluzione per restituire un errore durante il tentativo di creazione di un [!DNL Adobe Target IMS] configurazione da integrare [!DNL AEM] con [!DNL Adobe Target]. |
| Agosto 2023 | [[!DNL Adobe Experience Manager]: abilitare la barra di ricerca in Seleziona immagine della miniatura della pagina](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22690.html?lang=it) | Nuovo articolo | Scopri come abilitare la barra di ricerca in Seleziona immagine della miniatura della pagina. |
| Agosto 2023 | [[!DNL Adobe Experience Manager Forms]: How to change [!DNL JBoss®] percorso registro?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22689.html?lang=it) | Nuovo articolo | Scopri come modificare il [!DNL JBoss®] percorso di accesso [!DNL AEM Forms] in un [!DNL Windows Server] ambiente. |
| Agosto 2023 | [Pubblicazione del contenuto non annullata dall’anteprima dopo l’eliminazione nell’ambiente di authoring](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22685.html?lang=it) | Nuovo articolo | Scopri la soluzione alternativa per eliminare una pagina precedentemente pubblicata in anteprima senza prima disattivarla; non verrà eliminata dall’anteprima. |
| Agosto 2023 | [La miniatura è nera sulle risorse video mp4 caricate](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22671.html?lang=it) | Nuovo articolo | Scopri la soluzione alternativa dopo aver caricato i file mp4; le miniature generate sono nere. |
| Agosto 2023 | [[!DNL GraphQL API] in [!DNL AEMaaCS] non è estensibile](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22619.html?lang=it) | Nuovo articolo | Informazioni su [!DNL GraphQL API] in [!DNL AEMaaCS] non è estensibile. |
| Agosto 2023 | [[!DNL AEM GraphQL] problemi di configurazione](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22615.html?lang=it) | Nuovo articolo | Scopri come la configurazione di quando sviluppi un sito web che deve recuperare dati dai propri [!DNL AEM] istanze che utilizzano [!DNL AEM] soluzione headless. |
| Agosto 2023 | [Assenza dell’istanza di produzione in [!DNL New Relic]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22582.html?lang=it) | Nuovo articolo | Scopri la soluzione per l’istanza di produzione che non viene visualizzata nel servizio di monitoraggio delle applicazioni *[!DNL New Relic]*. |
...
| Data di pubblicazione | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |
| Settembre 2023 | [Sconto articolo riga offerta di vendita B2B](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/b2b/b2b-quote/quote-line-item-notes.html?lang=en) | Video | Scopri come utilizzare le note sugli elementi riga per un preventivo B2B di Adobe Commerce. |
...
| Settembre 2023 | [Visualizzatore realtà aumentata per Adobe Commerce](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/catalog/augmented-reality.html) | Video | Scopri il modulo di visualizzazione della realtà aumentata disponibile sulla Commerce Marketplace. |
| Settembre 2023 | [Opzioni per importare un catalogo](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/catalog/catalog-import.html) | Video | Scopri alcune delle opzioni native per l’importazione del catalogo nel tuo store Adobe Commerce. |
| Settembre 2023 | [Percona Toolkit pt-query-digest](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/pt-query-digest.html) | Video | Scopri perché utilizzi pt-query-digest e alcuni esempi reali per contribuire ad approfondire il ragionamento. |
...
| Data di pubblicazione | Nome | Tipo | Descrizione |
|---------|--------|---------|---------|
| Agosto 2023 | [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/support-tools/patches/patches-available-in-qpt-tool-overview.html?lang=it) | Nuovi articoli | Nuovi articoli su come applicare le patch disponibili in [!DNL QPT] 1.1.34, [!DNL QPT] 1.1.35, e [!DNL QPT] 1.1.36 sono stati pubblicati e si trovano nelle rispettive sezioni. |
| Agosto 2023 | [[!DNL USPS Ground Advantage] hotfix di supporto per il metodo di spedizione per [!DNL AC-9182]](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/usps-ground-advantage-shipping-method-support-hotfix-for-ac-9182.html) | Nuovi articoli | Scopri una patch per risolvere il problema [!DNL AC-9182] per il nuovo [!DNL USPS Ground Advantage] metodo di spedizione in Adobe Commerce 2.4.4 - 2.4.6-p2. |
| Agosto 2023 | [_[!DNL Error opensearch search engine doesn't exist. Falling back to livesearch.]_](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/error-opensearch-search-engine-doesnt-exist-falling-back-to-livesearch.html) | Nuovi articoli | Scopri la soluzione del problema in cui viene visualizzato l’errore: _[!DNL Error: opensearch search engine doesn't exist. Falling back to livesearch.]_in Adobe Commerce su infrastruttura cloud dove [!DNL Live Search] viene utilizzato. |
| Agosto 2023 | [[!DNL JQuery UI] security vulnerability [!DNL CVE-2022-31160] correzione per le versioni 2.4.4, 2.4.5 e 2.4.6](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/jquery-cve-2022-31160-fix-2.4.4-2.4.5-2.4.6.html) | Nuovi articoli | Scopri le informazioni su una vulnerabilità di sicurezza [!DNL CVE-2022-31160] segnalato per [!DNL jQuery-UI] libreria versione 1.13.1 che viene utilizzata come dipendenza in Adobe Commerce 2.4.4, 2.4.5 e 2.4.6. |
| Agosto 2023 | [Riduci scaduti _[!DNL oauth_tokens]_prima dell’aggiornamento 2.4.6](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/installation-and-upgrade/reduce-expired-oauth-tokens-before-2.4.6-upgrade.html) | Nuovi articoli | Scopri una soluzione al problema in cui puoi vedere molti *[!DNL oauth_tokens]* nel tuo *[!DNL oauth_token]* che può causare un lungo ritardo nell’aggiornamento alla versione 2.4.6. |
| Agosto 2023 | [Errori di distribuzione durante il commit di file non corretti](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/deployment/deployment-error-when-committing-incorrect-files.html) | Nuovi articoli | Scopri la soluzione al problema che si verifica quando si ottengono errori di distribuzione causati da commit non corretti nell’archivio di file/cartelle che non avrebbero dovuto essere aggiunti. |
| Agosto 2023 | [Pianificazione della versione di Adobe Commerce 2024](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/announcements/commerce-announcements/2024-release-schedule.html) | Nuovi articoli | Scopri la nostra strategia aggiornata per il rilascio del 2023 per espandere la finestra di supporto, fornire ulteriori aggiornamenti di sicurezza e accelerare l’adozione dell’innovazione. |
| Agosto 2023 | [[!DNL Admin] accesso non funzionante - dimensione massima sessione consentita superata](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/admin-login-not-working-allowed-session-max-size-exceed.html) | Nuovi articoli | Scopri la soluzione per quando tenti di accedere al tuo [!DNL Admin] ma il modulo si aggiorna e non puoi accedere. |
...
| Data di pubblicazione | Nome | Tipo | Descrizione |
|---------|----|----|-----------|
| Agosto 2023 | [[!DNL Error: "URL-140005 Unable to decode URLs of schema ' https'. Not implemented"]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22594.html?lang=it) | Nuovo articolo | Scopri la soluzione per ottenere un errore durante l’accesso a un [!DNL ACC (Adobe Campaign Classic)] account. |
| Agosto 2023 | [[!DNL Adobe Campaign Classic: 'Feedback_loop_'] mancato recapito per consegne e-mail non riuscite](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22531.html?lang=it) | Nuovo articolo | Scopri la soluzione per [!DNL 'Feedback_loop_'] mancate consegne e-mail non riuscite. |
| Agosto 2023 | [Errore durante l’invio di consegne a destinatari non inclusi nel database](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22570.html?lang=it) | Nuovo articolo | Scopri la soluzione alternativa per quando si tenta di inviare consegne alla copia manuale dei destinatari delle istantanee del database che non sono memorizzati nel database ([!DNL DB]) tramite un file esterno, viene generato un errore durante la preparazione della consegna. |
...
| Agosto 2023 | [Gli utenti amministratori non vengono informati degli errori in [!DNL OOTB ffdaReplicateStagingData] workflow](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22525.html?lang=it) | Nuovo articolo | Scopri la soluzione per quando, in qualità di utente amministratore, non ricevi notifiche quando si verificano errori in [!DNL OOTB ffdaReplicateStagingData] flusso di lavoro. |
| Agosto 2023 | [[!DNL Campaign Classic]: error enriching [!DNL BigQuery] dati](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22687.html?lang=it) | Nuovo articolo | Scopri la soluzione a quando crei un flusso di lavoro che legge i dati da un [!DNL BigQuery] , quindi aggiungi un’attività di arricchimento per arricchire i dati con un’attività [!DNL ACC] e l’esecuzione del flusso di lavoro genera un errore. |
...
| Data di pubblicazione | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |
| Settembre 2023 | [Novità delle esercitazioni di Workfront](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/home.html?lang=en#what%E2%80%99s-new%3F) | Video multipli | Scopri gli ultimi tutorial rilasciati nell’ultimo mese. |
...
| Data di pubblicazione | Applicazione | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |---------- |
| Settembre 2023 | Acrobat Sign | [Firmare documenti in movimento](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/mobile/mobile-tutorials/sign-mobile.html?lang=en) | Video | Scopri come firmare documenti utilizzando l’app mobile Acrobat Sign per iOS o Android™. |
| Settembre 2023 | Acrobat Sign | [Microsoft® Dynamics 365 per la vendita](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/microsoft/dynamics-sales.html) | Video | Scopri come Acrobat Sign e Microsoft® Dynamics 365 for Sales vengono utilizzati per automatizzare il processo di firma delle offerte di vendita. In questo esempio, Microsoft® Dynamics 365 for Sales aiuta il team di vendita a [!DNL Contoso] chiudere le offerte più rapidamente e sfruttare meglio le opportunità con un&#39;unica visione del cliente e un processo di firma integrato. |
| Settembre 2023 | Acrobat Sign | [Microsoft® Dynamics 365 per il servizio sul campo](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/microsoft/dynamics-field-service.html?lang=en) | Video | Scopri come utilizzare un dispatcher di assistenza sul campo e un tecnico [!DNL Acrobat Sign], [!DNL Power Automate], e [!DNL Dynamics 365] per semplificare l&#39;impegno dei servizi sul campo. |
...
| Data di pubblicazione | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |
| Settembre 2023 | [Experience Cloud di diagrammi di architettura](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/architecture-overview/experience-cloud.html) | Articolo | Scopri in che modo le applicazioni, i servizi applicativi e gli Experienci Platform di Experience Cloud si adattano a un’architettura di marketing aziendale. |