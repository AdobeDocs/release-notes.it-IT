...
Aggiornato: **1° settembre 2022** - Consulta le [note sulla versione e i registri di modifica](https://aep-sdks.gitbook.io/docs/release-notes) di Adobe Experience Platform Mobile SDK.

## ![Icona](/assets/analytics.png) [!DNL Adobe Analytics] {#analytics}

Prossima versione: **14 settembre 2022**
...
Guarda il [video di panoramica sulla versione di agosto 2022](https://video.tv.adobe.com/v/345409/?quality=12) per un riepilogo delle funzioni aggiunte nella versione 2022.8.0 (agosto 2022). <!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
...
|  | ([!DNL Google Ads] account) La vista Campagne > Annunci ora include una colonna [!UICONTROL Forza annuncio] opzionale che indica quanto ogni annuncio di ricerca responsive (RSA) segue le [!DNL Google Ads] best practice per le prestazioni.<br><br>[!DNL Microsoft® Advertising] non attiva ancora un supporto simile tramite la relativa API. |
