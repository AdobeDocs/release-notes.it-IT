...
* **[!DNL Target]** | _Informazioni, intelligence e impatto della personalizzazione su larga scala_ | **1 aprile** | Innovazioni di Adobe Target, tra cui [!DNL Gen AI], e best practice su personalizzazione e sperimentazione basate sull’intelligenza artificiale su larga scala. | [Registrati](https://event.adobe.com/adobetargetmaturitywebinars03)

* **[!DNL Experience Manager, Experience Manager Assets, Experience Manager Forms, Experience Manager Sites, and Workfront]** | _Il mix perfetto: una nuova era di collaborazione con AEM e Workfront_ | **2 aprile** | Scopri in che modo Adobe Experience Manager e Workfront si integrano per aiutare i team a passare dall’ideazione alla consegna senza le solite difficoltà, garantendo l’organizzazione, l’allineamento al brand e la disponibilità rapida dei contenuti. | [Registrati](https://adobeevents.adobeconnect.com/eaqjw1zixw1f/event/registration.html?campaign-id=ExL)
...
Per informazioni sui componenti dell’interfaccia centrale [!DNL Experience Cloud] e sull’amministrazione di utenti e prodotti, consulta la guida [all’interfaccia e all’amministrazione di Experience Cloud](https://experienceleague.adobe.com/it/docs/core-services/interface/experience-cloud). Sono inclusi [!UICONTROL Attributi del cliente], [!DNL Experience Cloud Assets] e [!UICONTROL Tipi di pubblico].
...
| ----------| ---------- | ---------- | ---------- |---------- |
| Marzo 2025 | [!DNL Experience Platform] | [Panoramica delle regole di collegamento del grafo delle identità](https://experienceleague.adobe.com/it/docs/platform-learn/tutorials/identities/graph-linking-rules/overview) | Nuovo video | Ottieni una panoramica del modo in cui le regole di collegamento del grafo delle identità consentono ai data architect di mantenere profili cliente accurati ed evitare l’unione non intenzionale dei grafi di due persone distinte. |
...
|---------|----|----|-----------|
| Febbraio 2025 | [Nessuna ora calcolata nell’ambiente di produzione di AEP](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-25763) | Nuovo articolo | Scopri come risolvere un problema a causa del quale, in un ambiente di produzione di Adobe Experience Platform, la metrica **Ore calcolate** all’interno di [!UICONTROL Data Distiller] viene visualizzata come *zero*. |
| Febbraio 2025 | [Errore di completamento parziale nella connessione di Adobe Experience Platform e [!DNL Facebook] ](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-25738) | Nuovo articolo | Scopri come risolvere un problema di push degli eventi alla destinazione [!DNL Facebook] utilizzando Adobe Experience Platform, con codice di errore *ACTSVC-8100-400* che indica un *successo parziale*. |
| Febbraio 2025 | [Raccolta dati di AEP: Web SDK, quale livello di autorizzazioni è necessario per creare regole utilizzando l’API?](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-25710) | Nuovo articolo | Scopri il livello di autorizzazioni necessario per creare regole utilizzando l’API in Raccolta dati di AEP. |
| Febbraio 2025 | [Eventi non visualizzati nei profili associati a causa del criterio di unione assegnato in AEP](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-25690) | Nuovo articolo | Scopri come risolvere il problema che si verifica quando si inviano degli eventi a un set di dati associato a profili specifici: tali eventi vengono visualizzati nel set di dati ma non nei profili corrispondenti. |
| Febbraio 2025 | [*Errore interno del server 500* durante la creazione della destinazione Adobe Campaign in AEP](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-25850) | Nuovo articolo | Scopri come risolvere un problema di creazione di una destinazione Adobe Campaign in Adobe Experience Platform (AEP), con conseguente *errore interno del server 500*. |
| Febbraio 2025 | [I dati di riepilogo in [!DNL Segment Builder] sono diversi in Produzione e Sviluppo in AEP](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-25851) | Nuovo articolo | Scopri come risolvere un problema nei dati di riepilogo in [!DNL Segment Builder], con comportamenti diversi negli ambienti di produzione e sviluppo di Adobe Experience Platform. |
| Febbraio 2025 | [L’acquisizione di dati SFTP non funziona come previsto in AEP](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-25770) | Nuovo articolo | Scopri come risolvere un problema nel processo di acquisizione dati tramite origini [!DNL Secure File Transfer Protocol] (SFTP): il processo non funziona come previsto e il file previsto non viene caricato. |
...
| Pubblicato | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |
| Marzo 2025 | [Migrazione da Adobe Analytics a Web SDK tramite tag](https://experienceleague.adobe.com/it/docs/platform-learn/migrate-analytics-to-websdk/migration-to-websdk-overview) | Video multipli | Scopri i passaggi per effettuare la migrazione di un’implementazione di Adobe [!DNL Analytics] utilizzando l’estensione [!DNL Analytics] nei tag di Experience Platform (precedentemente nota come [!DNL Launch]) in Web SDK, utilizzando l’estensione Web SDK anche nei tag. |
...
Data di rilascio [!DNL Customer Journey Analytics]: **12 marzo 2025**
...
| Marzo 2025 | [!DNL AEM Headless as a Cloud Service] | [App Next.js](https://experienceleague.adobe.com/it/docs/experience-manager-learn/getting-started-with-aem-headless/how-to/example-apps/next-js) | Nuovo video | Le applicazioni di esempio sono un ottimo modo per esplorare le funzionalità headless di Adobe [!DNL Experience Manager] (AEM). Questa applicazione `Next.js` illustra come eseguire query sui contenuti che utilizzano le API GraphQL di AEM con query persistenti. |
