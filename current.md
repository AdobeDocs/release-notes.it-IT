...
| -----------|---------- |
| [Experience League LIVE](#exl-live) | Evento in diretta prodotto dal team di Experience League e ospitato su YouTube. Offre l’opportunità di entrare in contatto con gli esperti dei prodotti Adobe. Impara suggerimenti, trucchi e strategie da mettere in pratica nelle applicazioni Adobe Experience Cloud.<br> Scorri verso il basso per ulteriori informazioni sui prossimi eventi e guarda gli eventi passati ospitati su [Experience League Live](https://experienceleague.adobe.com/docs/experience-league-live-events/events/overview.html?lang=it). |
| [Coffee Break domande e risposte della community](#coffee) | Trascorri un’ora con un ospite speciale e invia le tue domande alle community Experience League. Ottieni risposte alle tue domande dagli esperti di prodotto di Adobe Prendi un caffè e chiacchiera con i responsabili di prodotto nelle community Experience League.<br>Scorri verso il basso per saperne di più. Non dimenticare di registrarti prima che sia troppo tardi. |
| [Adobe [!DNL Developers Live]](https://experienceleague.adobe.com/docs/adobe-developers-live-events/events/2021/oct2021/overview.html?lang=it) | Eventi video on-demand disponibili su Experience League. |
...
| Febbraio 2022 | [Scambiare il codice JWT con un token di accesso](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/doc-gen-formscs/create-access-token.html?lang=it) | Articolo | Il codice JWT creato nel passaggio [Creare un token web JSON (JWT)](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/doc-gen-formscs/create-jwt.html) viene scambiato con le API Adobe IMS per un token di accesso, che può quindi essere utilizzato per accedere a AEM as a Cloud Service. Scopri come richiedere un token di accesso per inviare una richiesta POST contenente JWT, client_id, client_secret al servizio di autenticazione IMS. | AEM Forms CS |
...
| Funzione | Descrizione |
| ------- | ----------- |
| [!UICONTROL Campagne], [!UICONTROL Bulksheet] | (Data di rilascio: 22 gennaio) ([!DNL Microsoft Advertising accounts]) Ora puoi creare e gestire annunci adattabili della rete di ricerca (RSA, Responsive Search Ads) dalla vista [!UICONTROL Campagne] > [!UICONTROL Annunci] e da [!UICONTROL Campagne] > [!UICONTROL Bulksheet]. |
| [!UICONTROL Bulksheet], [!UICONTROL Centro notifiche] | (Versione del 22 gennaio) Tutte le notifiche e-mail per i bulksheet, inviate da Advertising Cloud Search al completamento o al fallimento di un’operazione di bulksheet, vengono ora gestite dal [!UICONTROL Centro notifiche].<br><br>[!UICONTROL Bulksheet] è un nuovo tipo di notifica che dispone di preferenze proprie e si trova all’interno del [!UICONTROL Centro notifiche]. Le notifiche e-mail e le notifiche web sono abilitate per impostazione predefinita, ma è possibile modificare tale impostazione.<br><br>Il formato e il contenuto delle notifiche e-mail utilizzano il modello [!UICONTROL Centro notifiche] e includono un collegamento di download diretto per il file bulksheet o il file di errore associato. |
...
| Data di pubblicazione | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |
| 17 febbraio 2022 | Tutorial su Advertising Cloud | Video | Una nuova esercitazione video su &quot;[Come creare un posizionamento di visualizzazione standard](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/dsp/placement-create.html)&quot; è disponibile. |
