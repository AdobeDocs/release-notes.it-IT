...
| Luglio 2022 | [Usare lo strumento Patch di qualità](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/tools/quality-patch-tool.html) | Video | Scopri le [!UICONTROL Strumento Toppa di qualità], uno strumento a riga di comando che fornisce patch di qualità per Adobe Commerce e Magenti Open Source. |
...
| Luglio 2022 | [Gestisci stato ordine](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/orders/order-status.html) | Video | Scopri come controllare lo stato dell’ordine e i relativi dettagli e come modificare lo stato di un ordine, se necessario. |
