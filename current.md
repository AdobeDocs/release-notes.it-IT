...
Ultimo aggiornamento: **giovedì 28 febbraio 2024**

* [[!DNL Experience League] eventi e aggiornamenti](#events)  (aggiornato **28 febbraio**)
...
Aggiornato il **giovedì 28 febbraio 2024**

+++Dettagli

* **EXPERIENCE MANAGER** | Webinar | _Evento della community AEM dell’EMEA_ | Avremo una grande sessione interattiva sulla catena di fornitura dei contenuti per discutere i vostri obiettivi, i vostri risultati finora, le sfide che affrontate e come affrontarle. | **29 febbraio alle 15:00 GMT** | [Registrati](https://registration.adobe.com/AdobeAEM24/)

* **ADMIN e CAMPAIGN** | EXPERIENCE LEAGUE LIVE | _La nuova interfaccia utente di Adobe Campaign Web_ | Unisciti a noi il 29 febbraio per scoprire come pianificare, avviare e misurare le strategie cross-channel utilizzando la nuova interfaccia utente web di Adobe Campaign e per ottenere un’anteprima delle nuove funzionalità di intelligenza artificiale generativa. | **29 febbraio alle 8:00 PT** | [Registrati](https://engage.adobe.com/ExpLeagueLive-240229.html)

* **EXPERIENCE MANAGER** | Livestream | _App Builder compie 10,0 anni_ | Unisciti al team di progettazione di App Builder per scoprire le novità dell’ultima versione di CLI e le novità future, inclusi alcuni nuovi approcci per semplificare e aumentare le possibilità di debug. | **29 febbraio alle 9:00 PT** | [Registrati](https://streamyard.com/watch/i7TEbhnR73h9)

* **WORKFRONT** | Workshop per i clienti | _Informazioni: Workfront per questioni legali e di conformità_ | Unisciti a noi per un workshop su come la collaborazione con i team legali e di conformità può semplificare i processi, espandere la piattaforma Workfront a un pubblico più ampio nella tua organizzazione e aumentare il tasso di adozione. | **29 febbraio alle 9:30 PT** |[Registrati](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,-RtTT5LkeU2OT5UN6pjZiA,y4-cs7fHjEmhjyMRZ1Igcw,hjYyoGdB9UiGT2SRWhnc7A?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **WORKFRONT** | Evento community | _Connect: Chat con gli amministratori per marketing e creatività_ | Sei un amministratore di sistema per un team di marketing o creativo? Questa sessione orientata al cliente ti connette con altri amministratori per discutere di best practice, suggerimenti e trucchi. | **1 marzo alle 9:00 PT** | [Registrati](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,1qnTSsu1BE6bJ4ijFsYafg,COdPeWL3z0qsME9nhjnRwg,bm8peHjA-k-iHyuhPz3AYQ,bo2nqNAMPkWK1pTv9uBkvg,mc8vdHlpqkGI-aXgy1J5ug?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **WORKFRONT** | Webinar | _Attivazione con Workfront: gestione delle risorse_ | Esplora uno dei casi d’uso più significativi di Workfront, la gestione delle risorse, mentre Workfront Business Advisor di Adobe illustra l’utilizzo dei blueprint per creare facilmente sistemi di gestione del lavoro che si evolvono in base alle tue esigenze. | **7 marzo alle 13:00 CET** | [Registrati](https://events-emea5.adobeconnect.com/content/adobeconnect/43/5415868397/en/events/event/shared/5653751992/event_landing.html?sco-id=5639062191&amp;campaign-id=ExL&amp;_charset_=utf-8)

* **WORKFRONT** | Evento community | _Connect: Collettivo Workfront_ | Unisciti ad altri clienti Workfront per una sessione collettiva di risoluzione dei problemi e condivisione del successo. | **11 marzo alle 6:00 PT** | [Registrati](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,50kttP5-9UCWhh1BbCHcww,POUnBQTORE-I_fyzEM2lfA,bUuoFqpHqEqgxVRm7ajYUg?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **WORKFRONT** | Evento community | _Connect: Collettivo Workfront_ | Unisciti ad altri clienti Workfront per una sessione collettiva di risoluzione dei problemi e condivisione del successo. | **11 marzo alle 6:00 PT** | [Registrati](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,50kttP5-9UCWhh1BbCHcww,POUnBQTORE-I_fyzEM2lfA,bUuoFqpHqEqgxVRm7ajYUg?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **EXPERIENCE MANAGER** | Webinar | _Espressos &amp; Experience Manager: Perché l&#39;AEM è più potente nel cloud_ | Unisciti agli esperti di Adobe per discutere come garantire una transizione fluida al Cloud tramite la valutazione dei contenuti e la pianificazione della migrazione con strumenti come Best Practice Analyzer e Cloud Acceleration Manager. | **14 marzo alle 13:00 CET** | [Registrati](https://events-emea5.adobeconnect.com/content/adobeconnect/43/5415868397/en/events/event/shared/5621127355/event_landing.html?sco-id=5643219583&amp;campaign-id=ExL&amp;_charset_=utf-8)
...
| Febbraio 2024 | [Utilizzare un livello di dati per impostare [!DNL Analytics] le variabili nei tag di Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/using-a-data-layer-to-set-page-name-and-other-variables-via-tags.html?lang=it) | Video aggiornato | Scopri come estrarre i valori dal livello di dati e come utilizzarli nei tag di Experience Platform per popolare le variabili in Adobe Analytics. L’utilizzo di un livello di dati per Analytics e altre soluzioni di Experience Cloud è considerata una best practice. |
...
| Gennaio 2024 | [Errore *[!DNL org.apache.sling.api.request.TooManyCallsException]* nella console personalizzata](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23463.html?lang=it) | Nuovo articolo | Scopri come risolvere l’errore *[!DNL org.apache.sling.api.request.TooManyCallsException]* nella console personalizzata. |
...
| Gennaio 2024 | La [[!DNL OOTB] funzione `nms.eventHisto.GetMirrorUrl` non restituisce alcun  [!DNL URL]  o li restituisce errati [!DNL URL]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23477.html?lang=it) | Nuovo articolo | Scopri la soluzione al problema in un flusso di lavoro con un’attività [!DNL JS], quando chiamando la funzione [!DNL Out-of-the-box (OOTB)] `nms.eventHisto.GetMirrorUrl`, non viene restituito alcun [!DNL URL] o viene restituito un [!DNL URL] non corretto. |
| Gennaio 2024 | [Accedere alle cartelle  [!DNL SFTP]  in `/usr/local/neolane/nl6` o `/usr/local/neolane/nl6/var/`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23493.html?lang=it) | Nuovo articolo | Scopri cosa fare se hai bisogno di accedere alle cartelle [!DNL SFTP] in `/usr/local/neolane/nl6` o `/usr/local/neolane/nl6/var/` di [!DNL Adobe Campaign Classic]. |
...
| Febbraio 2024 | [Doppio consenso per [!DNL Sinch] e [!DNL Infobip]](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/sms-channel/sms-double-opt-in.html?lang=it) | Video | Scopri come configurare il doppio consenso per gli SMS. |
