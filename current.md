...
* **ANALISI** | Experience Makers: The Skill Exchange | _Scambio di competenze all’Adobe Summit per Adobe Analytics_ | Il 28 marzo 2024, ospiteremo Adobe Analytics Skill Exchange al Summit di Las Vegas! Registrati ora per scoprire suggerimenti, trucchi e best practice dei clienti e dei campioni di Analytics. | **28 marzo alle 9:00** | [Registrati](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=952%20953)

* **EXPERIENCE MANAGER** | Experience Makers: The Skill Exchange | _Scambio di competenze all&#39;Adobe Summit per l&#39;AEM_ | Il 28 marzo 2024, ospiteremo l’AEM Skill Exchange al Summit di Las Vegas! Registrati ora per scoprire i suggerimenti, i trucchi e le best practice dei clienti e dei campioni AEM. | **28 marzo alle 9:00** | [Registrati](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=950%20951)

* **EXPERIENCE MANAGER** | Experience Makers: The Skill Exchange | _Scambio di competenze all’Adobe Summit per il Marketo Engage_ | Il 28 marzo 2024, ospiteremo il Marketo Engage Skill Exchange al Summit di Las Vegas! Registrati ora per scoprire i suggerimenti, i trucchi e le best practice dei clienti e dei campioni di Marketo Engage. | **28 marzo alle 9:00** | [Registrati](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=954%20955)

* **WORKFRONT** | Experience Makers: The Skill Exchange | _Scambio di competenze all’Adobe Summit per Workfront_ | Il 28 marzo 2024, ospiteremo Adobe Workfront Skill Exchange al Summit di Las Vegas! Registrati ora per scoprire i suggerimenti, i trucchi e le best practice dei clienti di Workfront. | **28 marzo alle 9:00** | [Registrati](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=956%20957)
...
Informazioni su [Catena di fornitura contenuto](https://business.adobe.com/solutions/adobe-genstudio.html?lang=it), Adobe è una soluzione end-to-end per accelerare e semplificare i contenuti con intelligenza artificiale generativa e automazione intelligente.

+++Dettagli

| Pubblicato | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |
| Febbraio 2024 | [Tutorials catena di fornitura contenuto](https://experienceleague.adobe.com/docs/content-supply-chain-learn/tutorials/overview.html) | Video | Visualizza i tutorial sulla supply chain di contenuti su Experience League. La catena di fornitura dei contenuti è una soluzione end-to-end di Adobe che consente di accelerare e semplificare la catena di fornitura dei contenuti mediante l&#39;intelligenza artificiale generativa e l&#39;automazione intelligente. |
...
* [mercoledì 30 gennaio 2024](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2024/02142024.html#status)
...
**Autorizzazioni Experience Platform**

Correzioni:

* È ora possibile cercare le credenziali API per nome durante la visualizzazione o la modifica delle credenziali.
* Le informazioni sull’iscrizione al gruppo di utenti sono ora disponibili per ciascun ruolo quando si visualizza l’elenco di ruoli di un utente nella scheda ruoli. Il **[!UICONTROL Rimuovi Ruolo]** L&#39;opzione è disabilitata per gli utenti a cui è stato assegnato un ruolo solo tramite un gruppo di utenti.
...
| Pubblicato | Nome | Tipo | Descrizione |
|---------|----|----|-----------|
| Febbraio 2024 | [[!UICONTROL Acquisizione valore predefinito] in [!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23641.html) | Nuovo articolo | Scopri come impostare un valore predefinito durante l’acquisizione in [!DNL Adobe Experience Platform (AEP)], in particolare per [!DNL upsert] operazioni, è necessario utilizzare mappature esplicite nel processo di acquisizione dei dati. |
...
[!DNL Analytics] data di rilascio: **13 marzo 2024**
...
Video, tutorial o corsi nuovi o aggiornati pubblicati per Adobe Analytics.

| Pubblicato | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |
| Febbraio 2024 | [Creazione di elementi dati nei tag di Experience Platform per l’implementazione di Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-data-elements-in-tags-for-the-analytics-implementation.html) | Video | Creare elementi dati per [!DNL Analytics] implementazione nei tag in base alle variabili e agli eventi documentati in un documento Solution Design Reference (SDR). |
| Febbraio 2024 | [Creare una regola di pagina globale nei tag di Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-a-global-page-rule-in-tags.html) | Video | Scopri come impostare una regola di pagina globale per i punti dati da inviare ad Adobe Analytics su ogni pagina utilizzando i tag di Experience Platform. |
| Febbraio 2024 | [Convalidare la regola di caricamento pagina globale nei tag Experienci Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/validating-your-global-page-load-rule-in-tags.html) | Video | Scopri come convalidare la regola di caricamento della pagina globale con il debugger di Experience Platform. |
| Febbraio 2024 | [Creare regole di tag di Experience Platform per eventi di successo](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-tags-rules-for-success-events.html?lang=en) | Video | Scopri come utilizzare le regole nei tag per monitorare gli eventi di conversione (eventi di successo) sul sito. |
...
[!DNL Customer Journey Analytics] data di rilascio: **13 marzo 2024**
...
* Cloud Manager ora convalida le date di scadenza non solo per il [certificato](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-ssl-certificates/introduction.html?lang=it) principale, ma anche per i certificati intermedi.
...
* Nessuna documentazione pubblica disponibile su come aggiungere proprietà personalizzate alla definizione dell’indice pronta all’uso. Ulteriori informazioni su [aggiunta di proprietà personalizzate](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/integrations/workfront-connector-configure.html?lang=it#metadata-schema-mapping).
...
| Pubblicato | Applicazioni | Nome | Tipo | Descrizione |
| ----------| ---------- | ---------- | ---------- |---------- |
| Febbraio 2024 | Experience Manager Assets | [Flussi di lavoro con avvio automatico](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/configuring/auto-start-workflows.html?lang=it) | Video | Scopri come i flussi di lavoro con avvio automatico estendono l’elaborazione delle risorse in [!DNL AEM as a Cloud Service] richiamando automaticamente il flusso di lavoro personalizzato al momento del caricamento o della rielaborazione al termine dell’elaborazione delle risorse. |
| Febbraio 2024 | Experience Manager Sites | [Configurare l’authoring dei documenti](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/set-up.html) | Video | Guida alla configurazione dell&#39;authoring dei documenti per gli autori. |
| Febbraio 2024 | Experience Manager Sites | [Flussi di lavoro documenti](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-workflows.html) | Video | Scopri come utilizzare i flussi di lavoro dei documenti con l’authoring dei documenti AEM. |
| Febbraio 2024 | Experience Manager Sites | [Versioni dei documenti](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-versions.html) | Video | Scopri come creare versioni di documenti creati con l’authoring di documenti AEM. |
| Febbraio 2024 | AEM CS | [Cloud 5: ricerca di terze parti](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-3rd-party-search.html) | Video | Scopri come integrare al meglio la ricerca di terze parti nei Edge Delivery Services. |
...
| Febbraio 2024 | AEM Headless | [Campi personalizzati](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/extensibility/ui/content-fragments/examples/editor-custom-field.html?lang=en) | Video | Scopri come creare campi personalizzati nell’Editor frammento di contenuto AEM. |
| Febbraio 2024 | Experience Manager: AEM Cloud Manager, Marketo Engage | [Suggerimenti e trucchi per i campioni di AEM - Utilizzo dei registri in Cloud Manager](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/cloud-manager-using-logs.html) | Video | Dai un&#39;occhiata a questi suggerimenti del tuo collega campione di AEM, Rami EL Gamal. In questo video, Rami illustra come scaricare i registri in Cloud Manager e condividere i suggerimenti sulle best practice lungo il percorso. |
| Febbraio 2024 | AEM CS | [Cloud 5 - Monitoraggio utente reale (RUM)](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-rum.html?lang=en) | Video | Esplora le analisi di Real User Monitoring (RUM) offerte da Adobe ai propri siti AEM forniti con Edge Delivery Services e come utilizzare RUM per migliorare un sito web. |
| Febbraio 2024 | Experience Manager Forms | [Genera PDF con dati dall’invio di moduli basati su componenti core](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/document-services/generate-pdf-from-core-component-form-submission.html) | Video | Unisci i dati dall’invio di moduli basati su componenti core con il modello XDP nel flusso di lavoro. |
| Febbraio 2024 | AEM Cloud Manager | [Best practice e suggerimenti dei campioni di AEM - Preparazione e pianificazione della migrazione a AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/migration.html) | Video | Esplora i consigli degli esperti e le best practice del tuo collega campione di AEM, Wilson Faure. In questo video, esplora le complessità di pianificazione e preparazione per la migrazione a AEM as a Cloud Service. |
| Febbraio 2024 | Experience Manager Sites | [Cloud 5 - Lavoratori Edge](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-edge-workers.html?lang=en) | Video | Scopri l’importanza dei lavoratori edge in AEM Sites e nei Edge Delivery Services e come integrarli con i sistemi back-end. |
...
| Pubblicato | Nome | Tipo | Descrizione |
|---------|--------|---------|---------|
| Febbraio 2024 | [[!DNL CDN] modello in [!UICONTROL Impostazione applicazione] non salva](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23756.html) | Nuovo articolo | Scopri la soluzione alternativa quando [!DNL CDN] modello in [!UICONTROL Impostazione applicazione] non può essere salvato. |
| Febbraio 2024 | [JDK 11 cause `NoClassDefFoundError` [!DNL AEM] 6,5](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23581.html) | Nuovo articolo | Scopri come installare [!DNL CXF] pacchetti esterni per risolvere il problema `NoClassDefFoundError` dopo un aggiornamento a [!DNL Java™] 11 con [!DNL AEM] 6,5x |
| Febbraio 2024 | [Come qualificare un’ [!DNL AEM as Cloud Service] Ticket di supporto](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23750.html) | Nuovo articolo | Scopri come qualificare completamente un ticket in modo che il supporto possa elaborare e comprendere rapidamente il problema e quali informazioni sono necessarie. |
| Febbraio 2024 | [Informazioni sulla modifica di Server e [!DNL JVM] fuso orario per Europa/Parigi in [!DNL AEM as a Cloud Service]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23702.html) | Nuovo articolo | Informazioni sulla modifica di Server e [!DNL JVM] fuso orario per Europa/Parigi in [!DNL AEM as a Cloud Service]. |
| Febbraio 2024 | [I flussi di lavoro sono impostati su &quot;non modificabile&quot; dopo la distribuzione del codice](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23531.html) | Nuovo articolo | Scopri come risolvere il problema [!DNL AEM] problema in cui dopo la creazione di un flusso di lavoro in [!DNL AEM] seguito da una distribuzione del codice, [!UICONTROL Flusso di lavoro] viene visualizzato come &quot;Non modificabile&quot;. Come best practice, è consigliabile conservare [!UICONTROL Flusso di lavoro] modelli nella base di codice coerenti tra più ambienti, in modo da non dover ricreare [!UICONTROL Flussi di lavoro] per ogni ambiente. |
| Febbraio 2024 | [[!DNL DDoS] attacco o sovraccarico di bot [!DNL AEM] con traffico](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23718.html) | Nuovo articolo | Scopri come eseguire il debug di questo problema abilitando la registrazione abilitata a livello di Dispatcher e come migliorare il caching di Dispatcher in modo da evitare interruzioni dovute a picchi di traffico. |
| Febbraio 2024 | [Problemi e soluzioni comuni relativi all’acquisizione delle risorse](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23717.html) | Nuovo articolo | Scopri le più comuni [!DNL AEM] Scenari di problemi relativi all’acquisizione delle risorse e come analizzarli, tra cui elaborazione elevata, volume elevato, grandi dimensioni [!DNL DAM] archivi e molti autori simultanei. |
| Febbraio 2024 | [Limite massimo di varianti, criteri di prestazioni e conservazione di [!UICONTROL Frammenti di contenuto]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23715.html) | Nuovo articolo | Scopri il limite massimo al numero di varianti consentite in un singolo [!UICONTROL frammento di contenuto], se più varianti contribuiscono alla lentezza del sito e se sono presenti criteri di conservazione per eliminati [!UICONTROL frammenti di contenuto]. |
| Febbraio 2024 | [[!UICONTROL Richiesta eliminazione] flusso di lavoro attivato all’eliminazione del contenuto](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23690.html) | Nuovo articolo | Scopri quando un utente accede ed elimina una pagina o una risorsa in [!DNL AEM], il &quot;[!UICONTROL Richiesta eliminazione]&quot; viene attivato il flusso di lavoro. |
| Febbraio 2024 | [[!DNL HTML] file memorizzato in [!DNL CRX] non si apre nel browser, ma viene scaricato](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23689.html) | Nuovo articolo | A [!DNL HTML] file memorizzato direttamente in [!DNL Oak] L’archivio non si apre nel browser. Viene invece scaricato in [!DNL AEM 6.1 SP2] e versioni successive. |
| Febbraio 2024 | [[!DNL Adobe Experience Manager]: `WARN` messaggio di `Scheduler job requested thread pool with name org-apache-sling-sitemap`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23665.html) | Nuovo articolo | Scopri il problema durante la [!DNL AEM 6.5] avvio, `WARN` i messaggi vengono visualizzati più volte in `error.log`. |
| Febbraio 2024 | [[!DNL Adobe Experience Manager]: nodo con `sling:resourceType=wcm/msm/components/ghost`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23664.html) | Nuovo articolo | Scopri il problema quando, in alcuni casi, i nodi con un `sling:resourceType` valore di `wcm/msm/components/ghost` esiste. Questo articolo spiega come viene creato il nodo. |
...
| Pubblicato | Nome | Tipo | Descrizione |
| -----------| ---------- | ---------- | ---------- |
| Febbraio 2024 | [Connettere ed eseguire query sul database di Adobe Commerce](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/remote-db-connection-execute-queries.html?lang=en) | Video | Scopri come connettersi a un progetto on-cloud di Adobe Commerce, scaricare un database per l’utilizzo fuori sede, mascherare i dati PII e rimuoverlo. |
| Febbraio 2024 | [Commerce Cloud l&#39;onboarding tecnico e il handoff hardware - Timeline del processo di avvio](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/adobe-commerce-cloud/technical-onboarding-hardware-handoff/launch-process-timeline.html) | Video | Scopri l’onboarding tecnico di Adobe Commerce Cloud per la timeline del processo di lancio. |
...
| Pubblicato | Nome | Tipo | Descrizione |
|---------|--------|---------|---------|
| Febbraio 2024 | [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/support-tools/patches/patches-available-in-qpt-tool-overview.html?lang=it) | Nuovi articoli | Nuovi articoli su come applicare le patch disponibili in [!DNL QPT] 1.1.44, [!DNL QPT] 1.1.45, e [!DNL QPT] 1.1.46 sono stati pubblicati e si trovano nelle rispettive sezioni. |
| Febbraio 2024 | [Più righe nel database per la stessa entità](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/database/multiple-rows-in-database-for-same-entity.html) | Nuovi articoli | Questo articolo fornisce una soluzione al problema relativo alla presenza di più righe per lo stesso ID entità nel database. |
| Febbraio 2024 | [Recommendations [!DNL JS] errori dopo l’aggiornamento alla versione 2.4.5 di Adobe Commerce](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/installation-and-upgrade/recommendations-js-errors-after-upgrade-to-adobe-commerce-version-2-4-5.html) | Nuovi articoli | Questo articolo corregge alcuni casi in cui, dopo l’aggiornamento ad Adobe Commerce (tutti i metodi di distribuzione), [!DNL JS] errori nella console relativi ai moduli/unità Recommendations del prodotto. |
...
* [!DNL Campaign] v8.6: [Note sulla versione](https://experienceleague.adobe.com/docs/campaign/campaign-v8/releases/release-notes.html?lang=it) | [Documentazione del prodotto](https://experienceleague.adobe.com/docs/campaign/campaign-v8/campaign-home.html?lang=it)
...
| Febbraio 2024 | Interfaccia utente di Campaign Web | [Esplorare l’interfaccia utente di Campaign Web](https://experienceleague.adobe.com/docs/campaign-web-learn/tutorials/getting-started/explore-the-web-ui.html) | Video | Scopri come accedere e navigare nell’interfaccia utente di Campaign Web e come personalizzare gli elenchi di inventario. Scopri Knowledge Assistant basato sull’intelligenza artificiale. |
...
| Pubblicato | Nome | Tipo | Descrizione |
|---------|----|----|-----------|
| Febbraio 2024 | [Impossibile visualizzare correttamente la finestra dei modelli di consegna quando si è connessi a [!DNL Campaign Console] tramite [!DNL VPN]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23622.html) | Nuovo articolo | Scopri la soluzione del problema quando ti connetti a [!DNL Adobe Campaign Console] tramite [!DNL VPN], non puoi visualizzare i dati dei modelli di consegna all’interno della finestra. |
...
| Pubblicato | Nome | Tipo | Descrizione |
|---------|----|----|-----------|
| Febbraio 2024 | [Incapsulare le funzioni durante la creazione di espressioni utilizzando l’operatore &quot;+&quot;](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23749.html) | Nuovo articolo | Scopri come qualsiasi chiamata di funzione deve essere racchiusa tra parentesi quando utilizzi l’operatore &quot;+&quot;. |
...
| -----------| ---------- | ---------- | ---------- |---------- |
| Febbraio 2024 | [!DNL Adobe Firefly] | [Scopri Adobe Firefly](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/discover.html?lang=en) | Video | Scopri l’Adobe Firefly del futuro della creatività con l’intelligenza artificiale generativa, progettata per la sicurezza commerciale e l’innovazione. |
| Febbraio 2024 | [!DNL Adobe Firefly] | [Pagina di destinazione](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/landing-page.html?lang=en) | Video | Scopri come iniziare a utilizzare Adobe Firefly. |
| Febbraio 2024 | [!DNL Adobe Firefly] | [Riempimento generativo](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-fill.html?lang=en) | Video | Scopri come utilizzare il riempimento generativo per aggiungere, espandere o rimuovere contenuti dalle immagini in modo non distruttivo utilizzando semplici prompt di testo. Il riempimento generativo consente di migliorare la creatività e creare progetti straordinari. |
| Febbraio 2024 | [!DNL Adobe Firefly] | [Ricolorazione generativa](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-recolor.html?lang=en) | Video | Scopri come visualizzare all’istante in anteprima diverse varianti di colore per la confezione del prodotto, i poster o le immagini su file vettoriali. La ricolorazione generativa consente di ricolorare il colore il più rapidamente possibile durante la digitazione. Sperimenta idee &quot;off-the-wall&quot;, idea intorno a temi o palette diversi e produce più varianti in uno scatto. |
| Febbraio 2024 | [!DNL Adobe Firefly] | [Esempi di utilizzo del Firefly](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/examples.html?lang=en) | Video | Scopri come utilizzare il Firefly per creare presentazioni, moodboard, ideazioni, screensaver e altro ancora. |
| Febbraio 2024 | [!DNL Adobe Firefly] | [Effetti testo](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/text-effects.html?lang=en) | Video | Scopri come creare testo univoco e di ispirazione per i progetti utilizzando semplici prompt di testo. Gli effetti di testo consentono di migliorare la creatività e creare testo straordinario per i progetti. |
