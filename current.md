...
| ----------| ---------- | ---------- |---------- |
| 2025 settembre | [Tutorial sulla composizione del pubblico federato](https://experienceleague.adobe.com/en/docs/platform-learn/engage-with-audiences-from-your-data-warehouse-using-fac/overview) | Video | Interagisci con i tipi di pubblico direttamente dal tuo data warehouse utilizzando Federated Audience Composition (FAC). |
