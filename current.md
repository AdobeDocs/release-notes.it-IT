...
| [!DNL Experience Cloud] | [IA agente](https://experienceleague.adobe.com/it/docs/core-services/interface/features/agentic-ai) | Scopri l’agente di supporto del prodotto e Data Insights Agent (IA per l’agente). |
...
| Giugno 2025 | [I tag avanzati non funzionano in AEM Sites senza licenza Assets](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26842) | Nuovo articolo | Scopri le soluzioni al problema per cui i tag avanzati non funzionano in AEM Sites senza una licenza Assets. |
...
| luglio 2025 | [Creare un prodotto scaricabile](https://experienceleague.adobe.com/it/docs/commerce-learn/tutorials/getting-started/create-products/create-downloadable-product) | Nuovo video | Scopri come creare un prodotto scaricabile tramite l’API REST e l’amministratore di Adobe Commerce. |
| luglio 2025 | [Crea un prodotto bundle](https://experienceleague.adobe.com/it/docs/commerce-learn/tutorials/getting-started/create-products/create-bundle-product) | Nuovo video | Scopri come creare un prodotto bundle utilizzando l’API REST e l’amministratore Commerce. |
| luglio 2025 | [Crea un prodotto buono regalo](https://experienceleague.adobe.com/it/docs/commerce-learn/tutorials/getting-started/create-products/create-gift-card-product) | Nuovo video | Scopri come creare un prodotto gift card utilizzando l’API REST e l’amministratore Adobe Commerce. |
| luglio 2025 | [Dimostrazione completa di Connessione dati Adobe Commerce](https://experienceleague.adobe.com/it/docs/commerce-learn/tutorials/getting-started/capabilities/data-connection) | Nuovo video | Guarda una dimostrazione completa delle funzionalità di Adobe Commerce Data Connection. |
...
| Giugno 2025 | [Conto sandbox PayPal non verificato](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26836) | Nuovi articoli | Scopri le soluzioni al problema quando il tuo account sandbox PayPal non viene verificato, in modo da non poter completare l&#39;onboarding con [!UICONTROL Payment Services] in Adobe Commerce. |
| Giugno 2025 | [Risolvi la mancata corrispondenza delle versioni nell&#39;infrastruttura Adobe Commerce on Cloud](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26788) | Nuovi articoli | Scopri le soluzioni al problema quando la distribuzione da [!UICONTROL Staging] alla produzione non riesce se la versione dell’infrastruttura Adobe Commerce su Cloud in [!UICONTROL Staging] è precedente a quella in produzione. |
| Giugno 2025 | [Metodi di pagamento non visualizzati all&#39;estrazione con più indirizzi](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26824) | Nuovi articoli | Scopri le soluzioni al problema quando la maggior parte dei metodi di pagamento non viene visualizzata al momento del pagamento quando vengono utilizzati più indirizzi di spedizione. |
| Giugno 2025 | [Pagamenti con carta di credito non riusciti in un ambiente Sandbox](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26825) | Nuovi articoli | Scopri le soluzioni al problema quando una carta di credito di test non riesce in un ambiente Sandbox con API PayPal. |
| Giugno 2025 | [Risoluzione dei problemi relativi all&#39;installazione di Payment Services](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26826) | Nuovi articoli | Scopri le soluzioni al problema in cui si verificano errori durante l’installazione di Payment Services. |
| Giugno 2025 | [Dati report servizi di pagamento ritardati](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26837) | Nuovi articoli | Scopri le soluzioni al problema quando i dati dei rapporti sui servizi di pagamento in ritardo si verificano in Adobe Commerce. |
| Giugno 2025 | [Richiesta rifiutata dal gateway PayPal - problema fattura duplicata](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26838) | Nuovi articoli | Scopri le soluzioni al problema quando si verificano errori quando gli ID fattura duplicati vengono inviati a PayPal. |
| Giugno 2025 | [Ridurre `oauth_tokens` scaduti prima dell’aggiornamento 2.4.6](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26848) | Nuovi articoli | Scopri le soluzioni al problema quando nella tabella `oauth_tokens` viene visualizzato un numero elevato di `oauth_token`, che può causare un lungo ritardo nell&#39;aggiornamento alla versione 2.4.6. |
| Giugno 2025 | [Risoluzione dei problemi [!DNL Upgrade Compatibility Tool] errori](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26849) | Nuovi articoli | Scopri le soluzioni al problema quando si verificano errori durante l&#39;utilizzo di [!DNL Upgrade Compatibility Tool]. |
| Giugno 2025 | [403 errori durante l&#39;accesso [!DNL Site-Wide Analysis Tool] in Adobe Commerce](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26852) | Nuovi articoli | Scopri le soluzioni al problema quando si verificano errori 403 durante il tentativo di accedere a [!DNL Site-Wide Analysis Tool] in Adobe Commerce. |
| Giugno 2025 | [Password amministratore salvate come testo normale nel registro delle azioni](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26853) | Nuovi articoli | Scopri le soluzioni al problema quando un amministratore di Commerce crea un nuovo utente con privilegi di amministratore e la password viene salvata come testo normale nella tabella del database `magento_logging_event_changes`. |
| Giugno 2025 | [Come verificare il motivo per cui  [!DNL cron]  è stato disabilitato](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26854) | Nuovi articoli | Scopri le soluzioni per i problemi relativi a [!DNL cron] nei prodotti Adobe Commerce su infrastrutture cloud. |
| Giugno 2025 | [Sito non accessibile a causa del cloaking dell&#39;origine](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26856) | Nuovi articoli | Scopri le soluzioni al problema quando non è possibile accedere alla vetrina e/o all’amministratore del sito di produzione o dell’infrastruttura cloud [!UICONTROL Gestione temporanea] in Adobe Commerce. |
| Giugno 2025 | [Problemi relativi ai plug-in del compositore durante l&#39;aggiornamento ad Adobe Commerce 2.4.4](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26858) | Nuovi articoli | Scopri le soluzioni ai problemi relativi ai plug-in del compositore durante l’aggiornamento da Adobe Commerce 2.4.3 e versioni precedenti a Adobe Commerce 2.4.4 o versioni successive (quando vengono rilasciate versioni future). |
| Giugno 2025 | [Le immagini del prodotto non vengono visualizzate nonostante [!UICONTROL Modifica prodotto] ruoli immagine](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26859) | Nuovi articoli | Scopri le soluzioni al problema quando le immagini del prodotto non vengono visualizzate nella vetrina, nonostante i ruoli impostati nella pagina [!UICONTROL Modifica prodotto]. |
| Giugno 2025 | [Elasticsearch viene visualizzato come motore di ricerca nonostante [!DNL OpenSearch] l&#39;installazione](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26877) | Nuovi articoli | Scopri le soluzioni al problema per cui Elasticsearch viene ancora visualizzato come motore di ricerca per Adobe Commerce sul cloud anche dopo l&#39;installazione o l&#39;aggiornamento a [!DNL OpenSearch]. |
| Giugno 2025 | [Distribuzione bloccata con errore &quot;Impossibile caricare l&#39;applicazione nel cluster remoto&quot;](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26878) | Nuovi articoli | Scopri le soluzioni al problema in cui la distribuzione si blocca e il messaggio di errore si trova nel registro di distribuzione: *Errore: impossibile caricare l&#39;applicazione nel cluster remoto.* |
| Giugno 2025 | [Campi bloccati (disattivati) in Amministrazione Commerce](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26879) | Nuovi articoli | Scopri le soluzioni al problema quando non puoi modificare i campi bloccati (disattivati) in Commerce Admin. |
| Giugno 2025 | [*E: errore durante la verifica dell&#39;errore`routes.yaml`* durante [!UICONTROL Staging] o distribuzione produzione](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26880) | Nuovi articoli | Scopri le soluzioni al problema in cui si riceve il messaggio di errore *E: errore durante la verifica del messaggio di errore`routes.yaml`* durante il tentativo di distribuire il progetto nell&#39;ambiente di [!UICONTROL staging] o produzione. |
| Giugno 2025 | [Ridistribuzione ambiente non riuscita o [!DNL MySQL] server scomparso](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26881) | Nuovi articoli | Scopri le soluzioni al problema in cui l&#39;interruzione dello spazio allocato per [!DNL MySQL] causa errori di distribuzione bloccata o connessione al database. |
...
| Giugno 2025 | Errore [*404* durante l&#39;accesso a `robots.txt` in Adobe Commerce nell&#39;infrastruttura cloud](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26885) | Nuovi articoli | Scopri le soluzioni al problema quando si verifica un errore *404* durante l&#39;accesso al file `robots.txt` in Adobe Commerce sull&#39;infrastruttura cloud. |
| Giugno 2025 | [Risolvi `robots.txt`: impossibile aggiornare o visualizzare le impostazioni predefinite](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26886) | Nuovi articoli | Scopri le soluzioni al problema per cui il file `robots.txt` in Adobe Commerce è configurato correttamente, ma visualizza comunque le impostazioni predefinite o non viene aggiornato. |
| Giugno 2025 | [*Impossibile eliminare il file. Avviso!unlink: errore di file o directory non presente* dall&#39;amministratore](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26887) | Nuovi articoli | Scopri le soluzioni al problema quando l&#39;errore *Impossibile eliminare il file. Attenzione!unlink: errore di file o directory non presente* nell&#39;amministratore di Commerce quando si esegue uno scaricamento di JavaScript/CSS. |
| Giugno 2025 | [La ricerca della corrispondenza esatta non funziona in Adobe Commerce 2.4.x](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26888) | Nuovi articoli | Scopri le soluzioni al problema in cui i risultati della ricerca in vetrina utilizzando la stessa stringa di ricerca differiscono in Adobe Commerce 2.4.x rispetto ad Adobe Commerce 2.3.x. |
| Giugno 2025 | [Eliminazione sicura dei file quando lo spazio su disco in Adobe Commerce nell&#39;infrastruttura cloud è esaurito](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26889) | Nuovi articoli | Scopri le soluzioni al problema di spazio su disco insufficiente e della necessità di rimuovere i file in modo sicuro. |
...
| Giugno 2025 | [Impossibile salvare la spedizione come chiave URL](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26896) | Nuovi articoli | Scopri le soluzioni al problema quando non sei in grado di salvare la spedizione come chiave URL (ad esempio: */shipping*) per i prodotti o le pagine CMS. |
| Giugno 2025 | [Applica una patch per continuare l&#39;offerta [!DNL DHL] come corriere](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26897) | Nuovi articoli | Scopri come applicare una patch per supportare lo schema aggiornato della versione 6.2 per continuare a offrire [!DNL DHL] come vettore di spedizione. |
| Giugno 2025 | [Il pannello di navigazione superiore non viene caricato nella vetrina](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26898) | Nuovi articoli | Scopri le soluzioni al problema per cui il contenuto di determinate pagine, in genere il pannello di navigazione superiore, non viene visualizzato nella vetrina se [!DNL Varnish] viene utilizzato per la memorizzazione in cache. |
| Giugno 2025 | [Impossibile modificare **[!UICONTROL Motore di ricerca]** con l&#39;amministrazione di Commerce (**[!UICONTROL Il menu Motore di ricerca]** non è accessibile)](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26899) | Nuovi articoli | Scopri le soluzioni al problema di non poter modificare il **[!UICONTROL motore di ricerca]** di Adobe Commerce utilizzando l&#39;amministratore di Commerce se il campo **[!UICONTROL Motore di ricerca]** non è visualizzato o se la casella di controllo **[!UICONTROL Usa valore di sistema]** è disabilitata e non accessibile. |
| Giugno 2025 | [Plug-in del compositore contro attacchi di confusione delle dipendenze](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26900) | Nuovi articoli | Scopri le soluzioni ai problemi con il plug-in del compositore rilasciato per attacchi di confusione delle dipendenze. |
| Giugno 2025 | [Indici invalidati e `indexer_reindex_all_invalid` eseguiti costantemente](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26901) | Nuovi articoli | Scopri le soluzioni al problema quando il sito presenta problemi di prestazioni causati da una reindicizzazione costante. |
| Giugno 2025 | [Prestazioni lente a causa di pagine non memorizzabili nella cache](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26903) | Nuovi articoli | Scopri le soluzioni al problema quando i tempi di caricamento o le interruzioni del sito Web aumentano a causa della disabilitazione della cache di pagina intera (ad esempio: [!DNL Fastly]) per qualsiasi blocco su pagine che devono essere memorizzate nella cache. |
| Giugno 2025 | [Passa alla versione 10.0 [!DNL DHL] schema per continuare l&#39;offerta [!DNL DHL] spedizione](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26904) | Nuovi articoli | Scopri le soluzioni che consentono ai commercianti di continuare a offrire [!DNL DHL] come soluzione di spedizione dopo che la versione 6.2 dello schema [!DNL DHL] è diventata obsoleta alla fine di dicembre 2022. |
| Giugno 2025 | [Disattiva l&#39;output del banner Adobe Commerce per migliorare le prestazioni del sito](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26909) | Nuovi articoli | Scopri le soluzioni al problema di prestazioni del sito insufficienti causate dall&#39;attivazione ma non utilizzo del modulo `Magento_Banner`. |
| Giugno 2025 | [Distribuzione non riuscita: impossibile applicare la patch MDVA-43395](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26911) | Nuovi articoli | Scopri le soluzioni al problema per cui l’applicazione della patch MDVA-43395 genera un’implementazione non riuscita. |
| Giugno 2025 | [La distribuzione non riesce con &quot;*Errore durante la compilazione del progetto: l&#39;hook di compilazione non è riuscito con codice di stato 1*&quot;](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26912) | Nuovi articoli | Scopri le soluzioni al problema in cui la fase di compilazione del processo di distribuzione non riesce e il messaggio di errore viene riepilogato con: *Errore durante la compilazione del progetto: hook di compilazione non riuscito con codice di stato 1.* |
| Giugno 2025 | [Errori di distribuzione dall&#39;abilitazione del modulo alpha [!DNL Baler] early](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26914) | Nuovi articoli | Scopri le soluzioni al problema quando si verificano errori di distribuzione quando si utilizza il modulo [!DNL Baler] in un ambiente di produzione. |
| Giugno 2025 | [La distribuzione non riesce con le chiavi di accesso corrette in `env:COMPOSER_AUTH` o `auth.json`](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26921) | Nuovi articoli | Scopri le soluzioni al problema quando la distribuzione non riesce con un errore *file non scaricabile (HTTP/1.1 404 - Non trovato)* nel registro di distribuzione. |
| Giugno 2025 | [[!DNL MySQL] tabelle troppo grandi](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26945) | Nuovi articoli | Scopri le soluzioni al problema quando una tabella [!DNL MySQL] supera 1 GB. |
| Giugno 2025 | [Informazioni sui consigli per la configurazione delle code nel rapporto di revisione dell&#39;ambiente](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26956) | Nuovi articoli | Scopri i rapporti di revisione dell’ambiente e i consigli relativi alla configurazione della coda nell’infrastruttura Adobe Commerce su cloud. |
| Giugno 2025 | [Ritira spedizione diretta all&#39;indirizzo errato](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26962) | Nuovi articoli | Scopri le soluzioni al problema per cui la soluzione di spedizione utilizza l’indirizzo predefinito del negozio invece dell’indirizzo di origine del prodotto per la spedizione diretta. |
...
| Giugno 2025 | [Comprendere come il Centro messaggi influisce sui profili attivi in Adobe Campaign v8](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26812) | Nuovo articolo | Scopri in che modo il Centro messaggi influisce sui profili attivi in Adobe Campaign v8. |
...
| luglio 2025 | [!DNL Journey Optimizer] | [Aggiungi campi modulo a modelli di canale esperienza basati su codice](https://experienceleague.adobe.com/it/docs/journey-optimizer-learn/tutorials/channels/code-based-experience-channel/form-fields-in-code-based-experiences) | Nuovo video | Scopri come gli sviluppatori possono semplificare la collaborazione con i team di marketing abilitando campi modificabili all’interno dei canali di esperienza basati su codice. |
...
| Giugno 2025 | [Percorsi sono approvati automaticamente in Adobe Journey Orchestration](https://experienceleague.adobe.com/it/docs/experience-cloud-kcs/kbarticles/ka-26929) | Nuovo articolo | Scopri le soluzioni al problema dell’approvazione automatica dei Percorsi in Adobe Journey Orchestration. |
...
| luglio 2025 | [Crea un report calendario personalizzato](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/reporting/calendar-reports/creating-custom-calendars.html?lang=it) | Nuovo video | Scopri come creare un calendario personalizzato. |
| luglio 2025 | [Interfaccia report calendario](https://experienceleague.adobe.com/it/docs/workfront-learn/tutorials-workfront/reporting/calendar-reports/tour-of-the-interface) | Nuovo video | Scopri l’interfaccia del calendario, compresi i raggruppamenti, le visualizzazioni e le azioni del calendario. |
| luglio 2025 | [Comprendere le opzioni aggiuntive per i report del calendario](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/reporting/calendar-reports/additional-calendar-options.html?lang=it) | Nuovo video | Scopri come copiare, modificare, condividere ed eliminare un calendario. |
